...
1. Merge the validated explicit-ending-rank milestone, then audit remaining scenario commands individually rather than treating already-implemented blocks and goal activation as absent.
