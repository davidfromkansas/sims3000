...
for(const value of ['',[],null,'0'.repeat(11999),'0'.repeat(11999)+'!'])assert.throws(()=>validateFloorPaint(value));assert.throws(()=>paintFloorSurfaces(d,[face(24)],1));assert.throws(()=>paintFloorSurfaces(d,[face(0)],7));assert.throws(()=>validateBuildingDesign({...defaultBuildingDesign(),surfacePaint:paint}));
