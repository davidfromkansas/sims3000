...
for(let material=0;material<=6;material++)for(let rotation=0;rotation<4;rotation++){const ctx={beginPath(){},closePath(){},fill(){},stroke(){},moveTo(x,y){assert.ok(x>=0&&x<=256&&y>=0&&y<=384);},lineTo(x,y){this.moveTo(x,y);}};drawBuildingDesign(ctx,{...design,blocks:Array(100).fill(24),materials:Array(500).fill(material)},rotation);}
