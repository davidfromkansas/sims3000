...
const controls=new Map(),make=()=>({value:'',style:{},disabled:false,setAttribute(){},focus(){},closest(){return this;}});for(const id of ['blockMode','blockWorkspace','blockUndo','blockRedo','blockTool','blockShape','blockSide','blockBrush','blockMaterial','blockStatus','blockFromTower','blockClear'])controls.set(id,make());
