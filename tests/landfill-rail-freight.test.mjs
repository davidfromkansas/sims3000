...
put(c,'road',12,8,35,8);home.waste=20;const storage=dump.garbage;processGarbage(c);assert.ok(Math.abs(dump.garbage-(storage-.5+20.24+2.4))<1e-7);put(c,'bulldoze',20,8);recompute(c);
