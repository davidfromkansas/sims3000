...
const more=fixture();assert.ok(build(more,'police',[{x:23,y:25}]).ok);startRiot(more,20,20);dispatchPolice(more,20,20);dispatchPolice(more,21,20);assert.equal(more.emergency.policeUnits.length,2);dispatchPolice(more,22,20);assert.equal(more.emergency.policeUnits.length,2);
