...
const actual=new Function('buildingLotPlacement','cityZonedSprite','designForTile','defaultLotDesign','drawDesignedBuilding','drawRecentConstruction','return function(city,t,c,u,fade){'+body+'}')(buildingLotPlacement,cityZonedSprite,designForTile,defaultLotDesign,(...args)=>calls.push(args),drawRecentConstruction);r.sprite=(...args)=>calls.push(args);r.layer='city';r.ctx={save(){},restore(){},beginPath(){},moveTo(){},lineTo(){},closePath(){},fill(){},stroke(){}};const ctx={fillText:(...args)=>markers.push(args)};
