...
for(const [type,capacity] of [['stadium',200],['university',500],['countyCourthouse',135]]){
...
console.log('PASS: stadium, university and courthouse supply finite 200/500/135-job pools, real commutes, no footprint duplication, service-loss recovery and saved employment.');
