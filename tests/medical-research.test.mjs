...
const saved=JSON.parse(serializeCity(c));assert.equal(saved.version,142);assert.equal(validateSave(saved).rewards.earned.medicalResearch,12);const old=structuredClone(saved);old.version=135;assert.throws(()=>validateSave(old));
