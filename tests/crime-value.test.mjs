...
assert.ok(build(c,'police',[{x:23,y:25}]).ok);assert.ok(home.crime<oldCrime);assert.ok(home.landValue>oldValue);assert.ok(c.stats.revenues.residential>=oldRevenue);
