...
c.civic.funding.police=25;recompute(c);assert.match(civicFacilityReport(c,at(29,23)),/operating radius is 15 tiles/);assert.match(civicFacilityReport(c,at(26,23)),/contributes 75 usable cells/);c.civic.funding.police=100;recompute(c);
