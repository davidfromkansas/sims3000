...
assert.equal(Object.keys(REPLACEABLE_STYLES).length,17);
for(const [source,style] of Object.entries(REPLACEABLE_STYLES).filter(([source])=>![76,77,78].includes(Number(source)))){
...
for(const [i,[source,style]] of Object.entries(REPLACEABLE_STYLES).filter(([source])=>![76,77,78].includes(Number(source))).entries()){
