...
const actual=new Function('structureSize','SERVICES','STRUCTURES','MODELED_POWER','MODELED_REWARDS','drawCityReward','stadiumMatchState','return function(city,t,c,p,u,fade){'+body+'}')(structureSize,SERVICES,STRUCTURES,new Set(),MODELED_REWARDS,(...args)=>calls.push(args),stadiumMatchState);
