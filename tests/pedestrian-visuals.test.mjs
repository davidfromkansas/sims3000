...
let arcs=0;const values=[],context=()=>new Proxy({},{get:(_,k)=>k.startsWith('create')?()=>({addColorStop(){}}):(...args)=>{if(k==='arc')arcs++;values.push(...args.filter(a=>typeof a==='number'));},set:()=>true});
