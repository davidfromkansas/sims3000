...
const saved=JSON.parse(serializeCity(c));assert.equal(saved.version,159);assert.equal(serializeCity(validateSave(saved)),serializeCity(c));const old=structuredClone(saved);old.version=143;assert.throws(()=>validateSave(old),/144/);
