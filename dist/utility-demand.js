...
import {occupancy,WATER_STRUCTURES} from './utilities.js?v=architecture-workspace-1';
import {SERVICES} from './civic.js?v=architecture-workspace-1';
import {FACILITIES} from './facilities.js?v=architecture-workspace-1';
