import {civicRoots} from './civic-footprints.js?v=reward-garbage-1';
import {civicServiceOperating} from './civic.js?v=reward-garbage-1';
import {REWARDS,rewardJobSites} from './rewards.js?v=reward-garbage-1';
