import {civicRoots} from './civic-footprints.js?v=civic-garbage-1';
import {civicServiceOperating} from './civic.js?v=civic-garbage-1';
import {REWARDS,rewardJobSites} from './rewards.js?v=civic-garbage-1';
