import {civicRoots} from './civic-footprints.js?v=architecture-collection-48';
import {civicServiceOperating} from './civic.js?v=architecture-collection-48';
import {REWARDS,rewardJobSites} from './rewards.js?v=architecture-collection-48';
