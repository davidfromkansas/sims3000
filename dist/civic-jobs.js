import {civicRoots} from './civic-footprints.js?v=architecture-collection-39';
import {civicServiceOperating} from './civic.js?v=architecture-collection-39';
import {REWARDS,rewardJobSites} from './rewards.js?v=architecture-collection-39';
