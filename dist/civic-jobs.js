import {civicRoots} from './civic-footprints.js?v=port-garbage-1';
import {civicServiceOperating} from './civic.js?v=port-garbage-1';
import {REWARDS,rewardJobSites} from './rewards.js?v=port-garbage-1';
