import {civicRoots} from './civic-footprints.js?v=architecture-collection-41';
import {civicServiceOperating} from './civic.js?v=architecture-collection-41';
import {REWARDS,rewardJobSites} from './rewards.js?v=architecture-collection-41';
