import {civicRoots} from './civic-footprints.js?v=automatic-police-response-1';
import {civicServiceOperating} from './civic.js?v=automatic-police-response-1';
import {REWARDS,rewardJobSites} from './rewards.js?v=automatic-police-response-1';
