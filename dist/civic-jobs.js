import {civicRoots} from './civic-footprints.js?v=architecture-collection-22';
import {civicServiceOperating} from './civic.js?v=architecture-collection-22';
import {REWARDS,rewardJobSites} from './rewards.js?v=architecture-collection-22';
