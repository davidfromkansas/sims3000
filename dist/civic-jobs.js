...
import {civicServiceOperating} from './civic.js?v=scenario-variable-manager-1';
import {REWARDS,rewardJobSites} from './rewards.js?v=scenario-variable-manager-1';
