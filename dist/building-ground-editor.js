import {projectedTowerOcclusion} from './building-tower-geometry.js?v=scripted-ending-ranks-1';
import {groundFaces,groundMaterial,paintGround,connectedGround} from './building-ground-paint.js?v=scripted-ending-ranks-1';
import {projectedBuildingSurfaces,pickBuildingSurface} from './building-surface-picking.js?v=scripted-ending-ranks-1';
import {buildingPropPickFaces,pickBuildingProp} from './building-prop-picking.js?v=scripted-ending-ranks-1';
import {BUILDING_MATERIALS,buildingMaterialName} from './building-materials.js?v=scripted-ending-ranks-1';
