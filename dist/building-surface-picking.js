import {BUILDING_MATERIAL_LIMIT} from './building-paint-colors.js?v=architecture-collection-55';
import {splitBuildingFloors} from './building-floor-paint.js?v=architecture-collection-55';
import {buildingBlockFaces} from './building-blocks.js?v=architecture-collection-55';
import {buildingVoxelFaces} from './building-voxels.js?v=architecture-collection-55';
import {projectBuildingPoint} from './building-footprints.js?v=architecture-collection-55';
import {validateBuildingMaterials,BUILDING_MATERIALS} from './building-materials.js?v=architecture-collection-55';
