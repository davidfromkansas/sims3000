import {civicRoots,civicCenter} from './civic-footprints.js?v=scenario-variable-manager-1';
import {EDUCATION_LAYERS} from './education-layers.js?v=scenario-variable-manager-1';
import {serviceRadius} from './civic.js?v=scenario-variable-manager-1';
