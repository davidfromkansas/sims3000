import {compileScenarioPrograms} from './scenario-programs.js?v=country-club-1';
import {validateEventDefinitions,validateEventCondition} from './scenario-events.js?v=country-club-1';
import {validateGoalStatusReferences} from './scenario-goal-status.js?v=country-club-1';
import {MAP_SIZES} from './city-grid.js?v=country-club-1';
