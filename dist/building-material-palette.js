import {solidPaletteHTML,mountSolidPalette} from './building-solid-palette.js?v=scenario-variable-manager-1';
import {BUILDING_MATERIALS,materialSurfaceColor,drawMaterialDetail} from './building-materials.js?v=scenario-variable-manager-1';
