import {tick} from './engine.js?v=keyboard-construction-1';
// The visible city is unchanged until a complete worker month is returned.
export function createSimulationRunner(makeWorker=()=>new Worker(new URL('./simulation-worker.js?v=keyboard-construction-1',import.meta.url),{type:'module'})){
