import {tick} from './engine.js?v=architecture-collection-55';
// The visible city is unchanged until a complete worker month is returned.
export function createSimulationRunner(makeWorker=()=>new Worker(new URL('./simulation-worker.js?v=architecture-collection-55',import.meta.url),{type:'module'})){
