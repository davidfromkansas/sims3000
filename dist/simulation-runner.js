import {tick} from './engine.js?v=playtest-checkpoints-2';
// The visible city is unchanged until a complete worker month is returned.
export function createSimulationRunner(makeWorker=()=>new Worker(new URL('./simulation-worker.js?v=playtest-checkpoints-2',import.meta.url),{type:'module'})){
