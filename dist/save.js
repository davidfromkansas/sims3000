import {HISTORY_LIMIT,METRICS} from './reports.js?v=scenario-calculations-1';
// Persist simulation inputs and history. Networks, coverage and statistics are rebuilt on load.
const CITY_FIELDS=['petitions','version','buildingDesigns','demographics','buildingReplacements','name','startYear','mayorName','difficulty','month','funds','seed','finance','civic','transport','region','emergency','scenario','business','rewards','tunnels','goals','starter'];
