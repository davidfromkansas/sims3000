import {HISTORY_LIMIT,METRICS} from './reports.js?v=large-city-performance-1';
// Persist simulation inputs and history. Networks, coverage and statistics are rebuilt on load.
const CITY_FIELDS=['size','petitions','version','buildingDesigns','demographics','buildingReplacements','name','startYear','mayorName','difficulty','month','funds','seed','finance','civic','transport','region','emergency','scenario','business','rewards','tunnels','goals','starter'];
export const TILE_FIELDS=['facilityAbandoned','abandonedLevel','historicalLevel','industry','farmRoot','x','y','elevation','treeLevel','terrain','waterKind','type','level','density','age','stress','nature','root','pipe','rail','subway','highway','bridgeAxis','railAxis','highwayAxis','waste','garbage','fire','fireAge','rubble','radiation','burnedLastMonth','recycledLastMonth'];
const HISTORY_FIELDS=[...Object.keys(METRICS),'month','population','funds','income','expenses','loanPayment','regionalPenalty','landValue','pollution','crime','education','lifeExpectancy'];
