import {landfillRailFreight} from './rail-freight.js?v=visible-garbage-backlog-1';
import {waterBaseNeed} from './utility-demand.js?v=visible-garbage-backlog-1';
import {pipeCoverage} from './water-coverage.js?v=visible-garbage-backlog-1';
import {conservationDemand} from './conservation.js?v=visible-garbage-backlog-1';
import {industrialJobs} from './industry.js?v=visible-garbage-backlog-1';
import {tradeCapacity} from './region.js?v=visible-garbage-backlog-1';
