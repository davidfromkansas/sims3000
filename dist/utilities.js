import {pipeCoverage} from './water-coverage.js?v=multi-neighbor-trade-1';
import {conservationDemand} from './conservation.js?v=multi-neighbor-trade-1';
import {industrialJobs} from './industry.js?v=multi-neighbor-trade-1';
import {tradeCapacity} from './region.js?v=multi-neighbor-trade-1';
