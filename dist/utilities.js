import {pipeCoverage} from './water-coverage.js?v=goal-activation-1';
import {conservationDemand} from './conservation.js?v=goal-activation-1';
import {industrialJobs} from './industry.js?v=goal-activation-1';
import {tradeCapacity} from './region.js?v=goal-activation-1';
