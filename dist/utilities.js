import {landfillRailFreight} from './rail-freight.js?v=first-repayment-1';
import {waterBaseNeed} from './utility-demand.js?v=first-repayment-1';
import {pipeCoverage} from './water-coverage.js?v=first-repayment-1';
import {conservationDemand} from './conservation.js?v=first-repayment-1';
import {industrialJobs} from './industry.js?v=first-repayment-1';
import {tradeCapacity} from './region.js?v=first-repayment-1';
