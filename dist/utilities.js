import {landfillRailFreight} from './rail-freight.js?v=disposal-maintenance-1';
import {waterBaseNeed} from './utility-demand.js?v=disposal-maintenance-1';
import {pipeCoverage} from './water-coverage.js?v=disposal-maintenance-1';
import {conservationDemand} from './conservation.js?v=disposal-maintenance-1';
import {industrialJobs} from './industry.js?v=disposal-maintenance-1';
import {tradeCapacity} from './region.js?v=disposal-maintenance-1';
