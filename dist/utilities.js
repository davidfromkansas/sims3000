import {facilityWasteProduction} from './facilities.js?v=east-asian-landmarks-1';
import {powerWasteProduction} from './power.js?v=east-asian-landmarks-1';
import {publicSpaceWasteProduction} from './public-space-waste.js?v=east-asian-landmarks-1';
import {civicWasteProduction} from './civic-waste.js?v=east-asian-landmarks-1';
import {rewardWasteProduction,garbageSourceRoads} from './reward-waste.js?v=east-asian-landmarks-1';
import {landfillRailFreight} from './rail-freight.js?v=east-asian-landmarks-1';
import {waterBaseNeed} from './utility-demand.js?v=east-asian-landmarks-1';
import {pipeCoverage} from './water-coverage.js?v=east-asian-landmarks-1';
import {conservationDemand} from './conservation.js?v=east-asian-landmarks-1';
import {industrialJobs} from './industry.js?v=east-asian-landmarks-1';
import {tradeCapacity} from './region.js?v=east-asian-landmarks-1';
