import {facilityWasteProduction} from './facilities.js?v=architecture-collection-53';
import {powerWasteProduction} from './power.js?v=architecture-collection-53';
import {publicSpaceWasteProduction} from './public-space-waste.js?v=architecture-collection-53';
import {civicWasteProduction} from './civic-waste.js?v=architecture-collection-53';
import {rewardWasteProduction,garbageSourceRoads} from './reward-waste.js?v=architecture-collection-53';
import {landfillRailFreight} from './rail-freight.js?v=architecture-collection-53';
import {waterBaseNeed} from './utility-demand.js?v=architecture-collection-53';
import {pipeCoverage} from './water-coverage.js?v=architecture-collection-53';
import {conservationDemand} from './conservation.js?v=architecture-collection-53';
import {industrialJobs} from './industry.js?v=architecture-collection-53';
import {tradeCapacity} from './region.js?v=architecture-collection-53';
