import {landfillRailFreight} from './rail-freight.js?v=city-hall-1';
import {waterBaseNeed} from './utility-demand.js?v=city-hall-1';
import {pipeCoverage} from './water-coverage.js?v=city-hall-1';
import {conservationDemand} from './conservation.js?v=city-hall-1';
import {industrialJobs} from './industry.js?v=city-hall-1';
import {tradeCapacity} from './region.js?v=city-hall-1';
