import {landfillRailFreight} from './rail-freight.js?v=automatic-police-response-1';
import {waterBaseNeed} from './utility-demand.js?v=automatic-police-response-1';
import {pipeCoverage} from './water-coverage.js?v=automatic-police-response-1';
import {conservationDemand} from './conservation.js?v=automatic-police-response-1';
import {industrialJobs} from './industry.js?v=automatic-police-response-1';
import {tradeCapacity} from './region.js?v=automatic-police-response-1';
