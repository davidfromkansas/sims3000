import {landfillRailFreight} from './rail-freight.js?v=fire-coverage-1';
import {waterBaseNeed} from './utility-demand.js?v=fire-coverage-1';
import {pipeCoverage} from './water-coverage.js?v=fire-coverage-1';
import {conservationDemand} from './conservation.js?v=fire-coverage-1';
import {industrialJobs} from './industry.js?v=fire-coverage-1';
import {tradeCapacity} from './region.js?v=fire-coverage-1';
