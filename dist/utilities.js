...
import {waterBaseNeed} from './utility-demand.js?v=playtest-checkpoints-2';
import {pipeCoverage} from './water-coverage.js?v=playtest-checkpoints-2';
import {conservationDemand} from './conservation.js?v=playtest-checkpoints-2';
import {industrialJobs} from './industry.js?v=playtest-checkpoints-2';
import {tradeCapacity} from './region.js?v=playtest-checkpoints-2';
