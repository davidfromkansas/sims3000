import {landfillRailFreight} from './rail-freight.js?v=hospital-patients-1';
import {waterBaseNeed} from './utility-demand.js?v=hospital-patients-1';
import {pipeCoverage} from './water-coverage.js?v=hospital-patients-1';
import {conservationDemand} from './conservation.js?v=hospital-patients-1';
import {industrialJobs} from './industry.js?v=hospital-patients-1';
import {tradeCapacity} from './region.js?v=hospital-patients-1';
