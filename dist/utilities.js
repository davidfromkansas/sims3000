import {landfillRailFreight} from './rail-freight.js?v=courtyard-apartments-1';
import {waterBaseNeed} from './utility-demand.js?v=courtyard-apartments-1';
import {pipeCoverage} from './water-coverage.js?v=courtyard-apartments-1';
import {conservationDemand} from './conservation.js?v=courtyard-apartments-1';
import {industrialJobs} from './industry.js?v=courtyard-apartments-1';
import {tradeCapacity} from './region.js?v=courtyard-apartments-1';
