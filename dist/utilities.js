import {landfillRailFreight} from './rail-freight.js?v=surface-fill-1';
import {waterBaseNeed} from './utility-demand.js?v=surface-fill-1';
import {pipeCoverage} from './water-coverage.js?v=surface-fill-1';
import {conservationDemand} from './conservation.js?v=surface-fill-1';
import {industrialJobs} from './industry.js?v=surface-fill-1';
import {tradeCapacity} from './region.js?v=surface-fill-1';
