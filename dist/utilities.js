import {landfillRailFreight} from './rail-freight.js?v=ordinance-comparison-1';
import {waterBaseNeed} from './utility-demand.js?v=ordinance-comparison-1';
import {pipeCoverage} from './water-coverage.js?v=ordinance-comparison-1';
import {conservationDemand} from './conservation.js?v=ordinance-comparison-1';
import {industrialJobs} from './industry.js?v=ordinance-comparison-1';
import {tradeCapacity} from './region.js?v=ordinance-comparison-1';
