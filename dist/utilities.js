import {landfillRailFreight} from './rail-freight.js?v=landfill-rail-freight-1';
import {waterBaseNeed} from './utility-demand.js?v=landfill-rail-freight-1';
import {pipeCoverage} from './water-coverage.js?v=landfill-rail-freight-1';
import {conservationDemand} from './conservation.js?v=landfill-rail-freight-1';
import {industrialJobs} from './industry.js?v=landfill-rail-freight-1';
import {tradeCapacity} from './region.js?v=landfill-rail-freight-1';
