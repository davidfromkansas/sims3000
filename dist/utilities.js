import {landfillRailFreight} from './rail-freight.js?v=arc-landmark-1';
import {waterBaseNeed} from './utility-demand.js?v=arc-landmark-1';
import {pipeCoverage} from './water-coverage.js?v=arc-landmark-1';
import {conservationDemand} from './conservation.js?v=arc-landmark-1';
import {industrialJobs} from './industry.js?v=arc-landmark-1';
import {tradeCapacity} from './region.js?v=arc-landmark-1';
