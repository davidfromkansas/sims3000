import {landfillRailFreight} from './rail-freight.js?v=jail-overcrowding-1';
import {waterBaseNeed} from './utility-demand.js?v=jail-overcrowding-1';
import {pipeCoverage} from './water-coverage.js?v=jail-overcrowding-1';
import {conservationDemand} from './conservation.js?v=jail-overcrowding-1';
import {industrialJobs} from './industry.js?v=jail-overcrowding-1';
import {tradeCapacity} from './region.js?v=jail-overcrowding-1';
