import {landfillRailFreight} from './rail-freight.js?v=financial-advisor-1';
import {waterBaseNeed} from './utility-demand.js?v=financial-advisor-1';
import {pipeCoverage} from './water-coverage.js?v=financial-advisor-1';
import {conservationDemand} from './conservation.js?v=financial-advisor-1';
import {industrialJobs} from './industry.js?v=financial-advisor-1';
import {tradeCapacity} from './region.js?v=financial-advisor-1';
