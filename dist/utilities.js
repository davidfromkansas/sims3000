import {landfillRailFreight} from './rail-freight.js?v=recent-construction-1';
import {waterBaseNeed} from './utility-demand.js?v=recent-construction-1';
import {pipeCoverage} from './water-coverage.js?v=recent-construction-1';
import {conservationDemand} from './conservation.js?v=recent-construction-1';
import {industrialJobs} from './industry.js?v=recent-construction-1';
import {tradeCapacity} from './region.js?v=recent-construction-1';
