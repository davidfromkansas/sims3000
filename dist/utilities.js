import {landfillRailFreight} from './rail-freight.js?v=water-recovery-scenario-1';
import {waterBaseNeed} from './utility-demand.js?v=water-recovery-scenario-1';
import {pipeCoverage} from './water-coverage.js?v=water-recovery-scenario-1';
import {conservationDemand} from './conservation.js?v=water-recovery-scenario-1';
import {industrialJobs} from './industry.js?v=water-recovery-scenario-1';
import {tradeCapacity} from './region.js?v=water-recovery-scenario-1';
