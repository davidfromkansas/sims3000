import {facilityWasteProduction} from './facilities.js?v=architecture-collection-55';
import {powerWasteProduction} from './power.js?v=architecture-collection-55';
import {publicSpaceWasteProduction} from './public-space-waste.js?v=architecture-collection-55';
import {civicWasteProduction} from './civic-waste.js?v=architecture-collection-55';
import {rewardWasteProduction,garbageSourceRoads} from './reward-waste.js?v=architecture-collection-55';
import {landfillRailFreight} from './rail-freight.js?v=architecture-collection-55';
import {waterBaseNeed} from './utility-demand.js?v=architecture-collection-55';
import {pipeCoverage} from './water-coverage.js?v=architecture-collection-55';
import {conservationDemand} from './conservation.js?v=architecture-collection-55';
import {industrialJobs} from './industry.js?v=architecture-collection-55';
import {tradeCapacity} from './region.js?v=architecture-collection-55';
