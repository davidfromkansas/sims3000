import {facilityWasteProduction} from './facilities.js?v=geyser-park-1';
import {powerWasteProduction} from './power.js?v=geyser-park-1';
import {publicSpaceWasteProduction} from './public-space-waste.js?v=geyser-park-1';
import {civicWasteProduction} from './civic-waste.js?v=geyser-park-1';
import {rewardWasteProduction,garbageSourceRoads} from './reward-waste.js?v=geyser-park-1';
import {landfillRailFreight} from './rail-freight.js?v=geyser-park-1';
import {waterBaseNeed} from './utility-demand.js?v=geyser-park-1';
import {pipeCoverage} from './water-coverage.js?v=geyser-park-1';
import {conservationDemand} from './conservation.js?v=geyser-park-1';
import {industrialJobs} from './industry.js?v=geyser-park-1';
import {tradeCapacity} from './region.js?v=geyser-park-1';
