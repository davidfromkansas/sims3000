import {landfillRailFreight} from './rail-freight.js?v=power-allocation-1';
import {waterBaseNeed} from './utility-demand.js?v=power-allocation-1';
import {pipeCoverage} from './water-coverage.js?v=power-allocation-1';
import {conservationDemand} from './conservation.js?v=power-allocation-1';
import {industrialJobs} from './industry.js?v=power-allocation-1';
import {tradeCapacity} from './region.js?v=power-allocation-1';
