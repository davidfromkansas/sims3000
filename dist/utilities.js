import {landfillRailFreight} from './rail-freight.js?v=scenario-results-1';
import {waterBaseNeed} from './utility-demand.js?v=scenario-results-1';
import {pipeCoverage} from './water-coverage.js?v=scenario-results-1';
import {conservationDemand} from './conservation.js?v=scenario-results-1';
import {industrialJobs} from './industry.js?v=scenario-results-1';
import {tradeCapacity} from './region.js?v=scenario-results-1';
