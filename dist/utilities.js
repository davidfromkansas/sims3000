import {pipeCoverage} from './water-coverage.js?v=background-controls-1';
import {conservationDemand} from './conservation.js?v=background-controls-1';
import {industrialJobs} from './industry.js?v=background-controls-1';
import {tradeCapacity} from './region.js?v=background-controls-1';
