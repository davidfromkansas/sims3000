import {landfillRailFreight} from './rail-freight.js?v=stadium-match-day-1';
import {waterBaseNeed} from './utility-demand.js?v=stadium-match-day-1';
import {pipeCoverage} from './water-coverage.js?v=stadium-match-day-1';
import {conservationDemand} from './conservation.js?v=stadium-match-day-1';
import {industrialJobs} from './industry.js?v=stadium-match-day-1';
import {tradeCapacity} from './region.js?v=stadium-match-day-1';
