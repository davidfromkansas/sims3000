import {facilityWasteProduction} from './facilities.js?v=responsive-metropolis-3';
import {powerWasteProduction} from './power.js?v=responsive-metropolis-3';
import {publicSpaceWasteProduction} from './public-space-waste.js?v=responsive-metropolis-3';
import {civicWasteProduction} from './civic-waste.js?v=responsive-metropolis-3';
import {rewardWasteProduction,garbageSourceRoads} from './reward-waste.js?v=responsive-metropolis-3';
import {landfillRailFreight} from './rail-freight.js?v=responsive-metropolis-3';
import {waterBaseNeed} from './utility-demand.js?v=responsive-metropolis-3';
import {pipeCoverage} from './water-coverage.js?v=responsive-metropolis-3';
import {conservationDemand} from './conservation.js?v=responsive-metropolis-3';
import {industrialJobs} from './industry.js?v=responsive-metropolis-3';
import {tradeCapacity} from './region.js?v=responsive-metropolis-3';
