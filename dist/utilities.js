import {landfillRailFreight} from './rail-freight.js?v=transport-advisor-1';
import {waterBaseNeed} from './utility-demand.js?v=transport-advisor-1';
import {pipeCoverage} from './water-coverage.js?v=transport-advisor-1';
import {conservationDemand} from './conservation.js?v=transport-advisor-1';
import {industrialJobs} from './industry.js?v=transport-advisor-1';
import {tradeCapacity} from './region.js?v=transport-advisor-1';
