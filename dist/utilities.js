import {pipeCoverage} from './water-coverage.js?v=scenario-neighbor-status-1';
import {conservationDemand} from './conservation.js?v=scenario-neighbor-status-1';
import {industrialJobs} from './industry.js?v=scenario-neighbor-status-1';
import {tradeCapacity} from './region.js?v=scenario-neighbor-status-1';
