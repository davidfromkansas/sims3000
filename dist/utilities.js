import {landfillRailFreight} from './rail-freight.js?v=civic-advisors-2';
import {waterBaseNeed} from './utility-demand.js?v=civic-advisors-2';
import {pipeCoverage} from './water-coverage.js?v=civic-advisors-2';
import {conservationDemand} from './conservation.js?v=civic-advisors-2';
import {industrialJobs} from './industry.js?v=civic-advisors-2';
import {tradeCapacity} from './region.js?v=civic-advisors-2';
