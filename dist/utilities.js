import {pipeCoverage} from './water-coverage.js?v=local-city-ambience-1';
import {conservationDemand} from './conservation.js?v=local-city-ambience-1';
import {industrialJobs} from './industry.js?v=local-city-ambience-1';
import {tradeCapacity} from './region.js?v=local-city-ambience-1';
