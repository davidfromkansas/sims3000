import {facilityWasteProduction} from './facilities.js?v=live-scenario-comparisons-2';
import {powerWasteProduction} from './power.js?v=live-scenario-comparisons-2';
import {publicSpaceWasteProduction} from './public-space-waste.js?v=live-scenario-comparisons-2';
import {civicWasteProduction} from './civic-waste.js?v=live-scenario-comparisons-2';
import {rewardWasteProduction,garbageSourceRoads} from './reward-waste.js?v=live-scenario-comparisons-2';
import {landfillRailFreight} from './rail-freight.js?v=live-scenario-comparisons-2';
import {waterBaseNeed} from './utility-demand.js?v=live-scenario-comparisons-2';
import {pipeCoverage} from './water-coverage.js?v=live-scenario-comparisons-2';
import {conservationDemand} from './conservation.js?v=live-scenario-comparisons-2';
import {industrialJobs} from './industry.js?v=live-scenario-comparisons-2';
import {tradeCapacity} from './region.js?v=live-scenario-comparisons-2';
...
export function wasteProduction(t,c){return t.type==='industrial'&&t.industry==='farm'?industrialJobs(t)*.02:isZone(t)?occupancy(t.level)*(t.type==='residential'?.24:t.type==='industrial'?.72:.36):c?rewardWasteProduction(c,t)+civicWasteProduction(c,t)+publicSpaceWasteProduction(c,t)+powerWasteProduction(c,t)+facilityWasteProduction(t)+(t.type==='recycling'&&wasteActive(c,t) ? .72 : 0):0;}
