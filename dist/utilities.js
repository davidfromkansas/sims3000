import {landfillRailFreight} from './rail-freight.js?v=anchored-camera-rotation-1';
import {waterBaseNeed} from './utility-demand.js?v=anchored-camera-rotation-1';
import {pipeCoverage} from './water-coverage.js?v=anchored-camera-rotation-1';
import {conservationDemand} from './conservation.js?v=anchored-camera-rotation-1';
import {industrialJobs} from './industry.js?v=anchored-camera-rotation-1';
import {tradeCapacity} from './region.js?v=anchored-camera-rotation-1';
