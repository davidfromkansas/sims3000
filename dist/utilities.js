import {landfillRailFreight} from './rail-freight.js?v=script-clipboard-2';
import {waterBaseNeed} from './utility-demand.js?v=script-clipboard-2';
import {pipeCoverage} from './water-coverage.js?v=script-clipboard-2';
import {conservationDemand} from './conservation.js?v=script-clipboard-2';
import {industrialJobs} from './industry.js?v=script-clipboard-2';
import {tradeCapacity} from './region.js?v=script-clipboard-2';
