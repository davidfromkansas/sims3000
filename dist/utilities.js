import {landfillRailFreight} from './rail-freight.js?v=floor-paint-1';
import {waterBaseNeed} from './utility-demand.js?v=floor-paint-1';
import {pipeCoverage} from './water-coverage.js?v=floor-paint-1';
import {conservationDemand} from './conservation.js?v=floor-paint-1';
import {industrialJobs} from './industry.js?v=floor-paint-1';
import {tradeCapacity} from './region.js?v=floor-paint-1';
