import {powerWasteProduction} from './power.js?v=infrastructure-garbage-1';
import {publicSpaceWasteProduction} from './public-space-waste.js?v=infrastructure-garbage-1';
import {civicWasteProduction} from './civic-waste.js?v=infrastructure-garbage-1';
import {rewardWasteProduction,garbageSourceRoads} from './reward-waste.js?v=infrastructure-garbage-1';
import {landfillRailFreight} from './rail-freight.js?v=infrastructure-garbage-1';
...
import {industrialJobs} from './industry.js?v=infrastructure-garbage-1';
import {tradeCapacity} from './region.js?v=infrastructure-garbage-1';
