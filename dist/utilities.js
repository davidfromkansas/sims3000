import {pipeCoverage} from './water-coverage.js?v=city-landscape-styles-1';
import {conservationDemand} from './conservation.js?v=city-landscape-styles-1';
import {industrialJobs} from './industry.js?v=city-landscape-styles-1';
import {tradeCapacity} from './region.js?v=city-landscape-styles-1';
