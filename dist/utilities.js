import {pipeCoverage} from './water-coverage.js?v=new-city-artwork-1';
import {conservationDemand} from './conservation.js?v=new-city-artwork-1';
import {industrialJobs} from './industry.js?v=new-city-artwork-1';
import {tradeCapacity} from './region.js?v=new-city-artwork-1';
