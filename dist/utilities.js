import {landfillRailFreight} from './rail-freight.js?v=scene-geometry-1';
import {waterBaseNeed} from './utility-demand.js?v=scene-geometry-1';
import {pipeCoverage} from './water-coverage.js?v=scene-geometry-1';
import {conservationDemand} from './conservation.js?v=scene-geometry-1';
import {industrialJobs} from './industry.js?v=scene-geometry-1';
import {tradeCapacity} from './region.js?v=scene-geometry-1';
