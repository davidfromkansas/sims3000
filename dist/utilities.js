import {landfillRailFreight} from './rail-freight.js?v=abandoned-recovery-1';
import {waterBaseNeed} from './utility-demand.js?v=abandoned-recovery-1';
import {pipeCoverage} from './water-coverage.js?v=abandoned-recovery-1';
import {conservationDemand} from './conservation.js?v=abandoned-recovery-1';
import {industrialJobs} from './industry.js?v=abandoned-recovery-1';
import {tradeCapacity} from './region.js?v=abandoned-recovery-1';
