import {pipeCoverage} from './water-coverage.js?v=background-months-1';
import {conservationDemand} from './conservation.js?v=background-months-1';
import {industrialJobs} from './industry.js?v=background-months-1';
import {tradeCapacity} from './region.js?v=background-months-1';
