import {landfillRailFreight} from './rail-freight.js?v=city-growth-guide-1';
import {waterBaseNeed} from './utility-demand.js?v=city-growth-guide-1';
import {pipeCoverage} from './water-coverage.js?v=city-growth-guide-1';
import {conservationDemand} from './conservation.js?v=city-growth-guide-1';
import {industrialJobs} from './industry.js?v=city-growth-guide-1';
import {tradeCapacity} from './region.js?v=city-growth-guide-1';
