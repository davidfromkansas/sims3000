import {pipeCoverage} from './water-coverage.js?v=large-city-routing-1';
import {conservationDemand} from './conservation.js?v=large-city-routing-1';
import {industrialJobs} from './industry.js?v=large-city-routing-1';
import {tradeCapacity} from './region.js?v=large-city-routing-1';
