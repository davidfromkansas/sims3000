import {landfillRailFreight} from './rail-freight.js?v=abandonment-history-1';
import {waterBaseNeed} from './utility-demand.js?v=abandonment-history-1';
import {pipeCoverage} from './water-coverage.js?v=abandonment-history-1';
import {conservationDemand} from './conservation.js?v=abandonment-history-1';
import {industrialJobs} from './industry.js?v=abandonment-history-1';
import {tradeCapacity} from './region.js?v=abandonment-history-1';
