import {showOrdinanceAnalysis} from './ordinance-analysis-ui.js?v=power-allocation-1';
import {zoneGrowthReport} from './zone-growth.js?v=power-allocation-1';
import {utilityTrendSnapshot} from './utility-trends.js?v=power-allocation-1';
import {averageWaterPollution} from './city-measures.js?v=power-allocation-1';
import {wasteFacilityData} from './waste-facility-report.js?v=power-allocation-1';
