import {showOrdinanceAnalysis} from './ordinance-analysis-ui.js?v=fire-coverage-1';
import {zoneGrowthReport} from './zone-growth.js?v=fire-coverage-1';
import {utilityTrendSnapshot} from './utility-trends.js?v=fire-coverage-1';
import {averageWaterPollution} from './city-measures.js?v=fire-coverage-1';
import {wasteFacilityData} from './waste-facility-report.js?v=fire-coverage-1';
