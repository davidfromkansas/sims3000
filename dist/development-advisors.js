import {showOrdinanceAnalysis} from './ordinance-analysis-ui.js?v=keyboard-cursor-1';
import {zoneGrowthReport} from './zone-growth.js?v=keyboard-cursor-1';
import {utilityTrendSnapshot} from './utility-trends.js?v=keyboard-cursor-1';
import {averageWaterPollution} from './city-measures.js?v=keyboard-cursor-1';
import {wasteFacilityData} from './waste-facility-report.js?v=keyboard-cursor-1';
