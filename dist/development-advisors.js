import {showOrdinanceAnalysis} from './ordinance-analysis-ui.js?v=architecture-collection-43';
import {zoneGrowthReport} from './zone-growth.js?v=architecture-collection-43';
import {utilityTrendSnapshot} from './utility-trends.js?v=architecture-collection-43';
import {averageWaterPollution} from './city-measures.js?v=architecture-collection-43';
import {wasteFacilityData} from './waste-facility-report.js?v=architecture-collection-43';
