import {zoneGrowthReport} from './zone-growth.js?v=first-repayment-1';
import {utilityTrendSnapshot} from './utility-trends.js?v=first-repayment-1';
import {averageWaterPollution} from './city-measures.js?v=first-repayment-1';
import {wasteFacilityData} from './waste-facility-report.js?v=first-repayment-1';
