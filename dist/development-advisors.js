...
import {zoneGrowthReport} from './zone-growth.js?v=architecture-collection-22';
import {utilityTrendSnapshot} from './utility-trends.js?v=architecture-collection-22';
import {averageWaterPollution} from './city-measures.js?v=architecture-collection-22';
import {wasteFacilityData} from './waste-facility-report.js?v=architecture-collection-22';
