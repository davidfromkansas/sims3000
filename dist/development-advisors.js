import {showOrdinanceAnalysis} from './ordinance-analysis-ui.js?v=architecture-collection-44';
import {zoneGrowthReport} from './zone-growth.js?v=architecture-collection-44';
import {utilityTrendSnapshot} from './utility-trends.js?v=architecture-collection-44';
import {averageWaterPollution} from './city-measures.js?v=architecture-collection-44';
import {wasteFacilityData} from './waste-facility-report.js?v=architecture-collection-44';
