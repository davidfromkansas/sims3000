import {showOrdinanceAnalysis} from './ordinance-analysis-ui.js?v=architecture-workspace-1';
import {zoneGrowthReport} from './zone-growth.js?v=architecture-workspace-1';
import {utilityTrendSnapshot} from './utility-trends.js?v=architecture-workspace-1';
import {averageWaterPollution} from './city-measures.js?v=architecture-workspace-1';
import {wasteFacilityData} from './waste-facility-report.js?v=architecture-workspace-1';
