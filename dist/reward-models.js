import {geyserPlumePixels} from './geyser-plume.js?v=architecture-workspace-1';
import {WHEEL,themeParkRidePixels} from './theme-park-rides.js?v=architecture-workspace-1';
import {stadiumMatchPixels} from './stadium-match.js?v=architecture-workspace-1';
