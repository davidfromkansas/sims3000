...
export function validateFloorPaint(value){if(typeof value!=='string'||value.length!==FLOOR_PAINT_SIZE||/[^0-7]/.test(value))throw Error('Floor paint needs 12,000 valid surface entries.');return value;}
