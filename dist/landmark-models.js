import {HERITAGE_LANDMARK_GEOMETRY} from './heritage-landmark-models.js?v=architecture-collection-55';
import {ASIAN_LANDMARK_GEOMETRY} from './asian-landmark-models.js?v=architecture-collection-55';
import {SKYLINE_LANDMARK_GEOMETRY} from './skyline-landmark-models.js?v=architecture-collection-55';
import {US_MEMORIAL_GEOMETRY} from './us-memorial-models.js?v=architecture-collection-55';
import {eiffelTowerGeometry} from './eiffel-tower-model.js?v=architecture-collection-55';
import {greatPyramidGeometry} from './great-pyramid-model.js?v=architecture-collection-55';
import {rasterizeMiniature} from './miniature-raster.js?v=architecture-collection-55';
import {helsinkiCathedralGeometry} from './helsinki-cathedral-model.js?v=architecture-collection-55';
// Original landmark geometry shared by the city renderer and gallery previews.
export const MODELED_LANDMARKS=new Set(['bigBen','statueLiberty','chryslerBuilding','arcDeTriomphe','helsinkiCathedral','eiffelTower','greatPyramid',...Object.keys(US_MEMORIAL_GEOMETRY),...Object.keys(SKYLINE_LANDMARK_GEOMETRY),...Object.keys(ASIAN_LANDMARK_GEOMETRY),...Object.keys(HERITAGE_LANDMARK_GEOMETRY)]);
...
export function landmarkGeometry(type){
 ...
 if(HERITAGE_LANDMARK_GEOMETRY[type]){HERITAGE_LANDMARK_GEOMETRY[type]({box,add,ring,beam});
