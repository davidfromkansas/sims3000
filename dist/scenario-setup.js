import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=expanding-farms-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=expanding-farms-1';
