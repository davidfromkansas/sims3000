import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=employment-trends-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=employment-trends-1';
