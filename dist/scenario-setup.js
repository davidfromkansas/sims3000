import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=age-teaching-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=age-teaching-1';
