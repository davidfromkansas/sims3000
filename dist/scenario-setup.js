import {recordWaterService} from './water-service.js?v=scene-geometry-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=scene-geometry-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=scene-geometry-1';
