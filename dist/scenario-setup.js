import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=scripted-goal-marks-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=scripted-goal-marks-1';
