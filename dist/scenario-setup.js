import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=earthquake-magnitude-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=earthquake-magnitude-1';
