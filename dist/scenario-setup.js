import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=goal-activation-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=goal-activation-1';
