import {startRiot,dispatchPolice} from './riots.js?v=architecture-collection-51';
import {prepareGrowthCapCity} from './growth-cap-city.js?v=architecture-collection-51';
import {takeLoan} from './economy.js?v=architecture-collection-51';
import {recordWaterService} from './water-service.js?v=architecture-collection-51';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=architecture-collection-51';
import {SCENARIOS,freshScenario} from './scenarios.js?v=architecture-collection-51';
