import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=variable-maps-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=variable-maps-1';
