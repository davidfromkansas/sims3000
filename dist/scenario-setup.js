import {recordWaterService} from './water-service.js?v=first-town-services-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=first-town-services-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=first-town-services-1';
