import {takeLoan} from './economy.js?v=first-repayment-1';
import {recordWaterService} from './water-service.js?v=first-repayment-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=first-repayment-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=first-repayment-1';
