import {recordWaterService} from './water-service.js?v=plane-navigation-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=plane-navigation-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=plane-navigation-1';
