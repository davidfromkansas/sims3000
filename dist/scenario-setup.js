import {takeLoan} from './economy.js?v=residential-cap-1';
import {recordWaterService} from './water-service.js?v=residential-cap-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=residential-cap-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=residential-cap-1';
