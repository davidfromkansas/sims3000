import {takeLoan} from './economy.js?v=power-allocation-1';
import {recordWaterService} from './water-service.js?v=power-allocation-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=power-allocation-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=power-allocation-1';
