import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=keyboard-construction-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=keyboard-construction-1';
