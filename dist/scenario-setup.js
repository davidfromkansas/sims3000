import {takeLoan} from './economy.js?v=department-policies-1';
import {recordWaterService} from './water-service.js?v=department-policies-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=department-policies-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=department-policies-1';
