import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=neighbor-economies-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=neighbor-economies-1';
