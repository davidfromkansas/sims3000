import {startRiot,dispatchPolice} from './riots.js?v=port-garbage-1';
import {prepareGrowthCapCity} from './growth-cap-city.js?v=port-garbage-1';
import {takeLoan} from './economy.js?v=port-garbage-1';
import {recordWaterService} from './water-service.js?v=port-garbage-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=port-garbage-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=port-garbage-1';
