import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=landmark-collection-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=landmark-collection-1';
