import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=goal-status-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=goal-status-1';
