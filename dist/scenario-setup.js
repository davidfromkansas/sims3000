import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=wind-motion-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=wind-motion-1';
