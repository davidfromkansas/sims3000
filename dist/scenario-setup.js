import {startRiot,dispatchPolice} from './riots.js?v=metropolis-growth-planning-1';
import {prepareGrowthCapCity} from './growth-cap-city.js?v=metropolis-growth-planning-1';
import {takeLoan} from './economy.js?v=metropolis-growth-planning-1';
import {recordWaterService} from './water-service.js?v=metropolis-growth-planning-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=metropolis-growth-planning-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=metropolis-growth-planning-1';
