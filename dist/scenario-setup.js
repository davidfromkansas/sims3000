import {startRiot,dispatchPolice} from './riots.js?v=infrastructure-garbage-1';
import {prepareGrowthCapCity} from './growth-cap-city.js?v=infrastructure-garbage-1';
import {takeLoan} from './economy.js?v=infrastructure-garbage-1';
import {recordWaterService} from './water-service.js?v=infrastructure-garbage-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=infrastructure-garbage-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=infrastructure-garbage-1';
