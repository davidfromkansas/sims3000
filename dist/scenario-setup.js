import {recordWaterService} from './water-service.js?v=visible-garbage-backlog-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=visible-garbage-backlog-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=visible-garbage-backlog-1';
