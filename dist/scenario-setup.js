import {recordWaterService} from './water-service.js?v=abandonment-history-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=abandonment-history-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=abandonment-history-1';
