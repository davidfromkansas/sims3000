import {prepareGrowthCapCity} from './growth-cap-city.js?v=adult-learning-1';
import {takeLoan} from './economy.js?v=adult-learning-1';
import {recordWaterService} from './water-service.js?v=adult-learning-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=adult-learning-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=adult-learning-1';
