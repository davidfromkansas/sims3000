import {recordWaterService} from './water-service.js?v=playtest-checkpoints-2';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=playtest-checkpoints-2';
import {SCENARIOS,freshScenario} from './scenarios.js?v=playtest-checkpoints-2';
