import {recordWaterService} from './water-service.js?v=seven-advisors-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=seven-advisors-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=seven-advisors-1';
