import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=civic-inspection-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=civic-inspection-1';
