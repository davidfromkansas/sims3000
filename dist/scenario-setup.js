import {takeLoan} from './economy.js?v=scenario-results-1';
import {recordWaterService} from './water-service.js?v=scenario-results-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=scenario-results-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=scenario-results-1';
