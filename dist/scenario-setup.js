import {startRiot,dispatchPolice} from './riots.js?v=architecture-collection-36';
import {prepareGrowthCapCity} from './growth-cap-city.js?v=architecture-collection-36';
import {takeLoan} from './economy.js?v=architecture-collection-36';
import {recordWaterService} from './water-service.js?v=architecture-collection-36';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=architecture-collection-36';
import {SCENARIOS,freshScenario} from './scenarios.js?v=architecture-collection-36';
