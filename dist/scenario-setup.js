import {recordWaterService} from './water-service.js?v=building-shape-tools-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=building-shape-tools-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=building-shape-tools-1';
