import {startRiot,dispatchPolice} from './riots.js?v=medical-research-center-1';
import {prepareGrowthCapCity} from './growth-cap-city.js?v=medical-research-center-1';
import {takeLoan} from './economy.js?v=medical-research-center-1';
import {recordWaterService} from './water-service.js?v=medical-research-center-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=medical-research-center-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=medical-research-center-1';
