import {recordWaterService} from './water-service.js?v=anchored-camera-rotation-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=anchored-camera-rotation-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=anchored-camera-rotation-1';
