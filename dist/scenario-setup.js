import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=building-paint-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=building-paint-1';
