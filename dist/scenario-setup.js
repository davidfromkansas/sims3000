import {recordWaterService} from './water-service.js?v=civic-advisors-2';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=civic-advisors-2';
import {SCENARIOS,freshScenario} from './scenarios.js?v=civic-advisors-2';
