import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=building-designer-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=building-designer-1';
