import {recordWaterService} from './water-service.js?v=script-clipboard-2';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=script-clipboard-2';
import {SCENARIOS,freshScenario} from './scenarios.js?v=script-clipboard-2';
