import {recordWaterService} from './water-service.js?v=loan-calendar-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=loan-calendar-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=loan-calendar-1';
