import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=education-service-maps-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=education-service-maps-1';
