import {recordWaterService} from './water-service.js?v=floor-paint-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=floor-paint-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=floor-paint-1';
