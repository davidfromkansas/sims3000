import {recordWaterService} from './water-service.js?v=navigation-cache-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=navigation-cache-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=navigation-cache-1';
