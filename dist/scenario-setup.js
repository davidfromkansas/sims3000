import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=scenario-dialog-text-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=scenario-dialog-text-1';
