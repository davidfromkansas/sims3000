import {startRiot,dispatchPolice} from './riots.js?v=responsive-metropolis-3';
import {prepareGrowthCapCity} from './growth-cap-city.js?v=responsive-metropolis-3';
import {takeLoan} from './economy.js?v=responsive-metropolis-3';
import {recordWaterService} from './water-service.js?v=responsive-metropolis-3';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=responsive-metropolis-3';
import {SCENARIOS,freshScenario} from './scenarios.js?v=responsive-metropolis-3';
