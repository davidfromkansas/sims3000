import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=navigation-data-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=navigation-data-1';
