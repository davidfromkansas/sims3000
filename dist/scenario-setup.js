import {recordWaterService} from './water-service.js?v=direct-model-paint-2';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=direct-model-paint-2';
import {SCENARIOS,freshScenario} from './scenarios.js?v=direct-model-paint-2';
