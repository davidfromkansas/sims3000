import {recordWaterService} from './water-service.js?v=shaped-details-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=shaped-details-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=shaped-details-1';
