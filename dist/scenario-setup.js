import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=multi-neighbor-trade-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=multi-neighbor-trade-1';
