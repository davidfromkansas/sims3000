import {startRiot,dispatchPolice} from './riots.js?v=science-center-2';
import {prepareGrowthCapCity} from './growth-cap-city.js?v=science-center-2';
import {takeLoan} from './economy.js?v=science-center-2';
import {recordWaterService} from './water-service.js?v=science-center-2';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=science-center-2';
import {SCENARIOS,freshScenario} from './scenarios.js?v=science-center-2';
