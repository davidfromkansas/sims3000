import {startRiot,dispatchPolice} from './riots.js?v=city-growth-guide-1';
import {prepareGrowthCapCity} from './growth-cap-city.js?v=city-growth-guide-1';
import {takeLoan} from './economy.js?v=city-growth-guide-1';
import {recordWaterService} from './water-service.js?v=city-growth-guide-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=city-growth-guide-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=city-growth-guide-1';
