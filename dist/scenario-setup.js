import {prepareGrowthCapCity} from './growth-cap-city.js?v=civic-damage-1';
import {takeLoan} from './economy.js?v=civic-damage-1';
import {recordWaterService} from './water-service.js?v=civic-damage-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=civic-damage-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=civic-damage-1';
