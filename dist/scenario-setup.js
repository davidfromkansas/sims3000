import {prepareGrowthCapCity} from './growth-cap-city.js?v=fire-coverage-1';
import {takeLoan} from './economy.js?v=fire-coverage-1';
import {recordWaterService} from './water-service.js?v=fire-coverage-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=fire-coverage-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=fire-coverage-1';
