import {startRiot,dispatchPolice} from './riots.js?v=country-club-1';
import {prepareGrowthCapCity} from './growth-cap-city.js?v=country-club-1';
import {takeLoan} from './economy.js?v=country-club-1';
import {recordWaterService} from './water-service.js?v=country-club-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=country-club-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=country-club-1';
