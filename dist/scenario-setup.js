import {recordWaterService} from './water-service.js?v=sloped-blocks-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=sloped-blocks-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=sloped-blocks-1';
