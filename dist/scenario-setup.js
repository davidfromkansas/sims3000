import {startRiot,dispatchPolice} from './riots.js?v=theme-park-1';
import {prepareGrowthCapCity} from './growth-cap-city.js?v=theme-park-1';
import {takeLoan} from './economy.js?v=theme-park-1';
import {recordWaterService} from './water-service.js?v=theme-park-1';
import {createCity,recompute,build,planBuild,selection,idx} from './engine.js?v=theme-park-1';
import {SCENARIOS,freshScenario} from './scenarios.js?v=theme-park-1';
