import {LANDSCAPE_STYLES,TREE_CHOICES,freshAppearance,validateAppearance,applyAppearance} from './city-appearance.js?v=scenario-neighbor-status-1';
import {drawAppearancePreview} from './appearance-preview.js?v=scenario-neighbor-status-1';
