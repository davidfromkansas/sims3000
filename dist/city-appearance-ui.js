import {LANDSCAPE_STYLES,TREE_CHOICES,freshAppearance,validateAppearance,applyAppearance} from './city-appearance.js?v=new-city-artwork-1';
import {drawAppearancePreview} from './appearance-preview.js?v=new-city-artwork-1';
