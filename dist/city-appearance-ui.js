import {LANDSCAPE_STYLES,TREE_CHOICES,freshAppearance,validateAppearance,applyAppearance} from './city-appearance.js?v=water-grid-report-1';
import {drawAppearancePreview} from './appearance-preview.js?v=water-grid-report-1';
