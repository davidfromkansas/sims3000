import {LANDSCAPE_STYLES,TREE_CHOICES,freshAppearance,validateAppearance,applyAppearance} from './city-appearance.js?v=direct-model-paint-2';
import {drawAppearancePreview} from './appearance-preview.js?v=direct-model-paint-2';
