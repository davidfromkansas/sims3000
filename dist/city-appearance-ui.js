import {LANDSCAPE_STYLES,TREE_CHOICES,freshAppearance,validateAppearance,applyAppearance} from './city-appearance.js?v=visible-garbage-backlog-1';
import {drawAppearancePreview} from './appearance-preview.js?v=visible-garbage-backlog-1';
