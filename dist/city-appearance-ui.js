import {LANDSCAPE_STYLES,TREE_CHOICES,freshAppearance,validateAppearance,applyAppearance} from './city-appearance.js?v=utility-usage-trends-1';
import {drawAppearancePreview} from './appearance-preview.js?v=utility-usage-trends-1';
