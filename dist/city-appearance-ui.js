import {LANDSCAPE_STYLES,TREE_CHOICES,freshAppearance,validateAppearance,applyAppearance} from './city-appearance.js?v=port-garbage-1';
import {drawAppearancePreview} from './appearance-preview.js?v=port-garbage-1';
