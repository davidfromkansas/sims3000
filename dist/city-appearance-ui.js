import {LANDSCAPE_STYLES,TREE_CHOICES,freshAppearance,validateAppearance,applyAppearance} from './city-appearance.js?v=available-job-targets-1';
import {drawAppearancePreview} from './appearance-preview.js?v=available-job-targets-1';
