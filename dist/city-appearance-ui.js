import {LANDSCAPE_STYLES,TREE_CHOICES,freshAppearance,validateAppearance,applyAppearance} from './city-appearance.js?v=scenario-result-1';
import {drawAppearancePreview} from './appearance-preview.js?v=scenario-result-1';
