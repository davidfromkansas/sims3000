import {LANDSCAPE_STYLES,TREE_CHOICES,freshAppearance,validateAppearance,applyAppearance} from './city-appearance.js?v=automatic-police-response-1';
import {drawAppearancePreview} from './appearance-preview.js?v=automatic-police-response-1';
