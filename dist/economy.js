...
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=education-service-maps-1';
import {industrialJobs,industryPollution} from './industry.js?v=education-service-maps-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=education-service-maps-1';
import {POWER_PLANTS} from './power.js?v=education-service-maps-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=education-service-maps-1';
