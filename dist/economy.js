...
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=anchored-camera-rotation-1';
import {industrialJobs,industryPollution} from './industry.js?v=anchored-camera-rotation-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=anchored-camera-rotation-1';
import {POWER_PLANTS} from './power.js?v=anchored-camera-rotation-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=anchored-camera-rotation-1';
