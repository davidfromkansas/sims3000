...
import {REWARDS,rewardRoots,rewardActive,CITY_HALL_EFFECTS} from './rewards.js?v=arc-landmark-1';
import {industrialJobs,industryPollution} from './industry.js?v=arc-landmark-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=arc-landmark-1';
import {POWER_PLANTS} from './power.js?v=arc-landmark-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=arc-landmark-1';
