import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=civic-models-1';
import {industrialJobs,industryPollution} from './industry.js?v=civic-models-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=civic-models-1';
import {POWER_PLANTS} from './power.js?v=civic-models-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=civic-models-1';
