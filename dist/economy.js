...
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=direct-model-paint-2';
import {industrialJobs,industryPollution} from './industry.js?v=direct-model-paint-2';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=direct-model-paint-2';
import {POWER_PLANTS} from './power.js?v=direct-model-paint-2';
import {civicSpending,ordinanceRevenue} from './civic.js?v=direct-model-paint-2';
