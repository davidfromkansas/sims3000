import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=airport-flights-1';
import {industrialJobs,industryPollution} from './industry.js?v=airport-flights-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=airport-flights-1';
import {POWER_PLANTS} from './power.js?v=airport-flights-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=airport-flights-1';
