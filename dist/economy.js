...
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=building-plane-guides-1';
import {industrialJobs,industryPollution} from './industry.js?v=building-plane-guides-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=building-plane-guides-1';
import {POWER_PLANTS} from './power.js?v=building-plane-guides-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=building-plane-guides-1';
