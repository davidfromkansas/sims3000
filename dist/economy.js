...
import {REWARDS,rewardRoots,rewardActive,CITY_HALL_EFFECTS} from './rewards.js?v=fire-readiness-1';
import {industrialJobs,industryPollution} from './industry.js?v=fire-readiness-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=fire-readiness-1';
import {POWER_PLANTS} from './power.js?v=fire-readiness-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=fire-readiness-1';
