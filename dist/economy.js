...
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=scenario-start-preview-1';
import {industrialJobs,industryPollution} from './industry.js?v=scenario-start-preview-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=scenario-start-preview-1';
import {POWER_PLANTS} from './power.js?v=scenario-start-preview-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=scenario-start-preview-1';
