...
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=available-job-targets-1';
import {industrialJobs,industryPollution} from './industry.js?v=available-job-targets-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=available-job-targets-1';
import {POWER_PLANTS} from './power.js?v=available-job-targets-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=available-job-targets-1';
