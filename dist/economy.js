...
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=scenario-building-utilities-1';
import {industrialJobs,industryPollution} from './industry.js?v=scenario-building-utilities-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=scenario-building-utilities-1';
import {POWER_PLANTS} from './power.js?v=scenario-building-utilities-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=scenario-building-utilities-1';
...
export function recomputeEnvironment(c){
 ...
 for(const t of rewardRoots(c)){if(!rewardActive(c,t))continue;const d=REWARDS[t.type];spread({x:t.x+Math.floor(d.size/2),y:t.y+Math.floor(d.size/2)},d.radius,(i,f)=>{amenity[i]+=d.amenity*f;});}
