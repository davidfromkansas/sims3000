...
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=building-shape-tools-1';
import {industrialJobs,industryPollution} from './industry.js?v=building-shape-tools-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=building-shape-tools-1';
import {POWER_PLANTS} from './power.js?v=building-shape-tools-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=building-shape-tools-1';
