import {outstandingLoanPayments} from './loan-debt.js?v=wind-motion-1';
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=wind-motion-1';
import {industrialJobs,industryPollution} from './industry.js?v=wind-motion-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=wind-motion-1';
import {POWER_PLANTS} from './power.js?v=wind-motion-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=wind-motion-1';
