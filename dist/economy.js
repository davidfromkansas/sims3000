...
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=recovery-sites-1';
import {industrialJobs,industryPollution} from './industry.js?v=recovery-sites-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=recovery-sites-1';
import {POWER_PLANTS} from './power.js?v=recovery-sites-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=recovery-sites-1';
