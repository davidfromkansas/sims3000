...
import {REWARDS,rewardSize,rewardRoots,rewardActive,CITY_HALL_EFFECTS} from './rewards.js?v=planned-zone-demand-1';
import {industrialJobs,industryPollution} from './industry.js?v=planned-zone-demand-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=planned-zone-demand-1';
import {POWER_PLANTS} from './power.js?v=planned-zone-demand-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=planned-zone-demand-1';
