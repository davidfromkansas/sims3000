...
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=underground-water-reading-2';
import {industrialJobs,industryPollution} from './industry.js?v=underground-water-reading-2';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=underground-water-reading-2';
import {POWER_PLANTS} from './power.js?v=underground-water-reading-2';
import {civicSpending,ordinanceRevenue} from './civic.js?v=underground-water-reading-2';
