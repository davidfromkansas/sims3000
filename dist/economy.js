...
import {REWARDS,rewardSize,rewardRoots,rewardActive,CITY_HALL_EFFECTS} from './rewards.js?v=power-overload-grace-1';
import {industrialJobs,industryPollution} from './industry.js?v=power-overload-grace-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=power-overload-grace-1';
import {POWER_PLANTS} from './power.js?v=power-overload-grace-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=power-overload-grace-1';
