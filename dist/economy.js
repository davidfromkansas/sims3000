...
import {REWARDS,rewardSize,rewardRoots,rewardActive,CITY_HALL_EFFECTS} from './rewards.js?v=stadium-project-1';
import {industrialJobs,industryPollution} from './industry.js?v=stadium-project-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=stadium-project-1';
import {POWER_PLANTS} from './power.js?v=stadium-project-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=stadium-project-1';
