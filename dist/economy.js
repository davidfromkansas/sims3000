...
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=civic-advisors-2';
import {industrialJobs,industryPollution} from './industry.js?v=civic-advisors-2';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=civic-advisors-2';
import {POWER_PLANTS} from './power.js?v=civic-advisors-2';
import {civicSpending,ordinanceRevenue} from './civic.js?v=civic-advisors-2';
