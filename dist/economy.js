import {outstandingLoanPayments} from './loan-debt.js?v=stadium-match-day-1';
import {REWARDS,rewardSize,rewardRoots,rewardActive,CITY_HALL_EFFECTS} from './rewards.js?v=stadium-match-day-1';
import {industrialJobs,industryPollution} from './industry.js?v=stadium-match-day-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=stadium-match-day-1';
import {POWER_PLANTS} from './power.js?v=stadium-match-day-1';
import {civicSpending,ordinanceRevenue} from './civic.js?v=stadium-match-day-1';
