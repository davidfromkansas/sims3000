import {powerBaseNeed,waterBaseNeed} from './utility-demand.js?v=live-scenario-comparisons-2';
import {EDUCATION_LAYERS,EDUCATION_LAYER_LEGEND,educationLayerProfile,educationLayerColor} from './education-layers.js?v=live-scenario-comparisons-2';
import {drawNavigationPrecincts,PRECINCT_LAYERS,PRECINCT_LEGEND,precinctCoverageNote} from './service-areas.js?v=live-scenario-comparisons-2';
import {mapSize} from './city-grid.js?v=live-scenario-comparisons-2';
