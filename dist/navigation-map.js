import {powerBaseNeed,waterBaseNeed} from './utility-demand.js?v=script-clipboard-2';
import {EDUCATION_LAYERS,EDUCATION_LAYER_LEGEND,educationLayerProfile,educationLayerColor} from './education-layers.js?v=script-clipboard-2';
import {drawNavigationPrecincts,PRECINCT_LAYERS,PRECINCT_LEGEND} from './service-areas.js?v=script-clipboard-2';
import {mapSize} from './city-grid.js?v=script-clipboard-2';
