import {powerBaseNeed,waterBaseNeed} from './utility-demand.js?v=reward-progress-1';
import {EDUCATION_LAYERS,EDUCATION_LAYER_LEGEND,educationLayerProfile,educationLayerColor} from './education-layers.js?v=reward-progress-1';
import {drawNavigationPrecincts,PRECINCT_LAYERS,PRECINCT_LEGEND,precinctCoverageNote} from './service-areas.js?v=reward-progress-1';
import {mapSize} from './city-grid.js?v=reward-progress-1';
