import {powerBaseNeed,waterBaseNeed} from './utility-demand.js?v=responsive-metropolis-3';
import {EDUCATION_LAYERS,EDUCATION_LAYER_LEGEND,educationLayerProfile,educationLayerColor} from './education-layers.js?v=responsive-metropolis-3';
import {drawNavigationPrecincts,PRECINCT_LAYERS,PRECINCT_LEGEND,precinctCoverageNote} from './service-areas.js?v=responsive-metropolis-3';
import {mapSize} from './city-grid.js?v=responsive-metropolis-3';
