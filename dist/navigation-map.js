import {powerBaseNeed,waterBaseNeed} from './utility-demand.js?v=port-garbage-1';
import {EDUCATION_LAYERS,EDUCATION_LAYER_LEGEND,educationLayerProfile,educationLayerColor} from './education-layers.js?v=port-garbage-1';
import {drawNavigationPrecincts,PRECINCT_LAYERS,PRECINCT_LEGEND,precinctCoverageNote} from './service-areas.js?v=port-garbage-1';
import {mapSize} from './city-grid.js?v=port-garbage-1';
