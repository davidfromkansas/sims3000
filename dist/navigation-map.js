import {powerBaseNeed,waterBaseNeed} from './utility-demand.js?v=architecture-collection-58';
import {EDUCATION_LAYERS,EDUCATION_LAYER_LEGEND,educationLayerProfile,educationLayerColor} from './education-layers.js?v=architecture-collection-58';
import {drawNavigationPrecincts,PRECINCT_LAYERS,PRECINCT_LEGEND,precinctCoverageNote} from './service-areas.js?v=architecture-collection-58';
import {mapSize} from './city-grid.js?v=architecture-collection-58';
