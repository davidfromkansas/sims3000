import {powerBaseNeed,waterBaseNeed} from './utility-demand.js?v=first-repayment-1';
import {EDUCATION_LAYERS,EDUCATION_LAYER_LEGEND,educationLayerProfile,educationLayerColor} from './education-layers.js?v=first-repayment-1';
import {drawNavigationPrecincts,PRECINCT_LAYERS,PRECINCT_LEGEND} from './service-areas.js?v=first-repayment-1';
import {mapSize} from './city-grid.js?v=first-repayment-1';
