import {civicSize} from './civic-footprints.js?v=architecture-collection-43';
import {REWARDS,rewardSize} from './rewards.js?v=architecture-collection-43';
import {civicJobSites,civicJobCapacity} from './civic-jobs.js?v=architecture-collection-43';
import {JobCapacity} from './job-capacity.js?v=architecture-collection-43';
import {workforceShare} from './workforce.js?v=architecture-collection-43';
import {routeLength} from './tunnels.js?v=architecture-collection-43';
import {industrialJobs} from './industry.js?v=architecture-collection-43';
import {streetGraph,MinQueue} from './highway.js?v=architecture-collection-43';
import {railNetwork,STATIONS} from './rail.js?v=architecture-collection-43';
