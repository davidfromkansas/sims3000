import {workforceShare} from './workforce.js?v=authored-goals-1';
import {routeLength} from './tunnels.js?v=authored-goals-1';
import {industrialJobs} from './industry.js?v=authored-goals-1';
import {streetGraph,MinQueue} from './highway.js?v=authored-goals-1';
import {railNetwork,STATIONS} from './rail.js?v=authored-goals-1';
