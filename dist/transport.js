import {civicSize} from './civic-footprints.js?v=police-presence-1';
import {REWARDS} from './rewards.js?v=police-presence-1';
import {civicJobSites,civicJobCapacity} from './civic-jobs.js?v=police-presence-1';
import {JobCapacity} from './job-capacity.js?v=police-presence-1';
import {workforceShare} from './workforce.js?v=police-presence-1';
import {routeLength} from './tunnels.js?v=police-presence-1';
import {industrialJobs} from './industry.js?v=police-presence-1';
import {streetGraph,MinQueue} from './highway.js?v=police-presence-1';
import {railNetwork,STATIONS} from './rail.js?v=police-presence-1';
