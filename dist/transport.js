import {civicSize} from './civic-footprints.js?v=fire-coverage-1';
import {REWARDS} from './rewards.js?v=fire-coverage-1';
import {civicJobSites,civicJobCapacity} from './civic-jobs.js?v=fire-coverage-1';
import {JobCapacity} from './job-capacity.js?v=fire-coverage-1';
import {workforceShare} from './workforce.js?v=fire-coverage-1';
import {routeLength} from './tunnels.js?v=fire-coverage-1';
import {industrialJobs} from './industry.js?v=fire-coverage-1';
import {streetGraph,MinQueue} from './highway.js?v=fire-coverage-1';
import {railNetwork,STATIONS} from './rail.js?v=fire-coverage-1';
