...
import {JobCapacity} from './job-capacity.js?v=scenario-variable-manager-1';
import {workforceShare} from './workforce.js?v=scenario-variable-manager-1';
import {routeLength} from './tunnels.js?v=scenario-variable-manager-1';
import {industrialJobs} from './industry.js?v=scenario-variable-manager-1';
import {streetGraph,MinQueue} from './highway.js?v=scenario-variable-manager-1';
import {railNetwork,STATIONS} from './rail.js?v=scenario-variable-manager-1';
