import {workforceShare} from './workforce.js?v=background-months-1';
import {routeLength} from './tunnels.js?v=background-months-1';
import {industrialJobs} from './industry.js?v=background-months-1';
import {streetGraph,MinQueue} from './highway.js?v=background-months-1';
import {railNetwork,STATIONS} from './rail.js?v=background-months-1';
