import {civicSize} from './civic-footprints.js?v=port-garbage-1';
import {REWARDS,rewardSize} from './rewards.js?v=port-garbage-1';
import {civicJobSites,civicJobCapacity} from './civic-jobs.js?v=port-garbage-1';
import {JobCapacity} from './job-capacity.js?v=port-garbage-1';
import {workforceShare} from './workforce.js?v=port-garbage-1';
import {routeLength} from './tunnels.js?v=port-garbage-1';
import {industrialJobs} from './industry.js?v=port-garbage-1';
import {streetGraph,MinQueue} from './highway.js?v=port-garbage-1';
import {railNetwork,STATIONS} from './rail.js?v=port-garbage-1';
