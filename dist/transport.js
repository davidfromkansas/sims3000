import {civicSize} from './civic-footprints.js?v=architecture-collection-57';
import {REWARDS,rewardSize} from './rewards.js?v=architecture-collection-57';
import {civicJobSites,civicJobCapacity} from './civic-jobs.js?v=architecture-collection-57';
import {JobCapacity} from './job-capacity.js?v=architecture-collection-57';
import {workforceShare} from './workforce.js?v=architecture-collection-57';
import {routeLength} from './tunnels.js?v=architecture-collection-57';
import {industrialJobs} from './industry.js?v=architecture-collection-57';
import {streetGraph,MinQueue} from './highway.js?v=architecture-collection-57';
import {railNetwork,STATIONS} from './rail.js?v=architecture-collection-57';
