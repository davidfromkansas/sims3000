...
import {JobCapacity} from './job-capacity.js?v=architecture-workspace-1';
import {workforceShare} from './workforce.js?v=architecture-workspace-1';
import {routeLength} from './tunnels.js?v=architecture-workspace-1';
import {industrialJobs} from './industry.js?v=architecture-workspace-1';
import {streetGraph,MinQueue} from './highway.js?v=architecture-workspace-1';
import {railNetwork,STATIONS} from './rail.js?v=architecture-workspace-1';
import {occupancy} from './utilities.js?v=architecture-workspace-1';
