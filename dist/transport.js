import {workforceShare} from './workforce.js?v=goal-status-1';
import {routeLength} from './tunnels.js?v=goal-status-1';
import {industrialJobs} from './industry.js?v=goal-status-1';
import {streetGraph,MinQueue} from './highway.js?v=goal-status-1';
import {railNetwork,STATIONS} from './rail.js?v=goal-status-1';
