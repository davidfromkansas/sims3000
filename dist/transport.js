import {workforceShare} from './workforce.js?v=emergency-order-1';
import {routeLength} from './tunnels.js?v=emergency-order-1';
import {industrialJobs} from './industry.js?v=emergency-order-1';
import {streetGraph,MinQueue} from './highway.js?v=emergency-order-1';
import {railNetwork,STATIONS} from './rail.js?v=emergency-order-1';
