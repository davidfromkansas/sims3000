...
import {REWARDS,rewardSize} from './rewards.js?v=theme-park-1';
import {civicJobSites,civicJobCapacity} from './civic-jobs.js?v=theme-park-1';
import {JobCapacity} from './job-capacity.js?v=theme-park-1';
import {workforceShare} from './workforce.js?v=theme-park-1';
import {routeLength} from './tunnels.js?v=theme-park-1';
import {industrialJobs} from './industry.js?v=theme-park-1';
import {streetGraph,MinQueue} from './highway.js?v=theme-park-1';
import {railNetwork,STATIONS} from './rail.js?v=theme-park-1';
