import {drawBuildingDecals} from './building-decals.js?v=scripted-ending-ranks-1';
import {wallDecorationFrame,clipWallDecoration} from './building-face-clipping.js?v=scripted-ending-ranks-1';
import {blockCornerHeights} from './building-block-geometry.js?v=scripted-ending-ranks-1';
import {buildingSurfaceDetail,drawBuildingSurfaceDetail} from './building-surface-details.js?v=scripted-ending-ranks-1';
import {floorSurfaceMaterial,splitBuildingFloors} from './building-floor-paint.js?v=scripted-ending-ranks-1';
...
import {materialSurfaceColor,drawMaterialDetail} from './building-materials.js?v=scripted-ending-ranks-1';
