import {blockCornerHeights} from './building-block-geometry.js?v=sloped-blocks-1';
import {buildingSurfaceDetail,drawBuildingSurfaceDetail} from './building-surface-details.js?v=sloped-blocks-1';
import {floorSurfaceMaterial,splitBuildingFloors} from './building-floor-paint.js?v=sloped-blocks-1';
import {projectBuildingPoint} from './building-footprints.js?v=sloped-blocks-1';
import {buildingShapeCells} from './building-shapes.js?v=sloped-blocks-1';
import {materialSurfaceColor,drawMaterialDetail} from './building-materials.js?v=sloped-blocks-1';
