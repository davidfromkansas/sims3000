import {validateSave,recompute} from './engine.js?v=abandonment-history-1';
import {serializeCity} from './save.js?v=abandonment-history-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=abandonment-history-1';
import {healthOutlook} from './health.js?v=abandonment-history-1';
import {educationTargets} from './education.js?v=abandonment-history-1';
