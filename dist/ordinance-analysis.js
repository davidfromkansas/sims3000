import {utilityTrendSnapshot} from './utility-trends.js?v=metropolis-growth-planning-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=metropolis-growth-planning-1';
import {validateSave,recompute} from './engine.js?v=metropolis-growth-planning-1';
import {serializeCity} from './save.js?v=metropolis-growth-planning-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=metropolis-growth-planning-1';
import {healthOutlook} from './health.js?v=metropolis-growth-planning-1';
import {educationTargets} from './education.js?v=metropolis-growth-planning-1';
