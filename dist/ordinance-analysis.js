import {validateSave,recompute} from './engine.js?v=seven-advisors-1';
import {serializeCity} from './save.js?v=seven-advisors-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=seven-advisors-1';
import {healthOutlook} from './health.js?v=seven-advisors-1';
import {educationTargets} from './education.js?v=seven-advisors-1';
