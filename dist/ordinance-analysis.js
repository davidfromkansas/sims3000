import {utilityTrendSnapshot} from './utility-trends.js?v=department-policies-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=department-policies-1';
import {validateSave,recompute} from './engine.js?v=department-policies-1';
import {serializeCity} from './save.js?v=department-policies-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=department-policies-1';
import {healthOutlook} from './health.js?v=department-policies-1';
import {educationTargets} from './education.js?v=department-policies-1';
