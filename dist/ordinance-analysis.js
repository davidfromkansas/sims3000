import {utilityTrendSnapshot} from './utility-trends.js?v=civic-damage-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=civic-damage-1';
import {validateSave,recompute} from './engine.js?v=civic-damage-1';
import {serializeCity} from './save.js?v=civic-damage-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=civic-damage-1';
import {healthOutlook} from './health.js?v=civic-damage-1';
import {educationTargets} from './education.js?v=civic-damage-1';
