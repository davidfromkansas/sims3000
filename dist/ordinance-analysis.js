import {utilityTrendSnapshot} from './utility-trends.js?v=city-growth-guide-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=city-growth-guide-1';
import {validateSave,recompute} from './engine.js?v=city-growth-guide-1';
import {serializeCity} from './save.js?v=city-growth-guide-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=city-growth-guide-1';
import {healthOutlook} from './health.js?v=city-growth-guide-1';
import {educationTargets} from './education.js?v=city-growth-guide-1';
