import {utilityTrendSnapshot} from './utility-trends.js?v=responsive-metropolis-3';
import {wasteActive,wasteCapacity} from './utilities.js?v=responsive-metropolis-3';
import {validateSave,recompute} from './engine.js?v=responsive-metropolis-3';
import {serializeCity} from './save.js?v=responsive-metropolis-3';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=responsive-metropolis-3';
import {healthOutlook} from './health.js?v=responsive-metropolis-3';
import {educationTargets} from './education.js?v=responsive-metropolis-3';
