import {utilityTrendSnapshot} from './utility-trends.js?v=keyboard-cursor-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=keyboard-cursor-1';
import {validateSave,recompute} from './engine.js?v=keyboard-cursor-1';
import {serializeCity} from './save.js?v=keyboard-cursor-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=keyboard-cursor-1';
import {healthOutlook} from './health.js?v=keyboard-cursor-1';
import {educationTargets} from './education.js?v=keyboard-cursor-1';
