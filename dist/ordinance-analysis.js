import {utilityTrendSnapshot} from './utility-trends.js?v=reward-progress-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=reward-progress-1';
import {validateSave,recompute} from './engine.js?v=reward-progress-1';
import {serializeCity} from './save.js?v=reward-progress-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=reward-progress-1';
import {healthOutlook} from './health.js?v=reward-progress-1';
import {educationTargets} from './education.js?v=reward-progress-1';
