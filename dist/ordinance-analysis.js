import {utilityTrendSnapshot} from './utility-trends.js?v=public-space-garbage-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=public-space-garbage-1';
import {validateSave,recompute} from './engine.js?v=public-space-garbage-1';
import {serializeCity} from './save.js?v=public-space-garbage-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=public-space-garbage-1';
import {healthOutlook} from './health.js?v=public-space-garbage-1';
import {educationTargets} from './education.js?v=public-space-garbage-1';
