import {utilityTrendSnapshot} from './utility-trends.js?v=university-neighborhood-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=university-neighborhood-1';
import {validateSave,recompute} from './engine.js?v=university-neighborhood-1';
import {serializeCity} from './save.js?v=university-neighborhood-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=university-neighborhood-1';
import {healthOutlook} from './health.js?v=university-neighborhood-1';
import {educationTargets} from './education.js?v=university-neighborhood-1';
