...
import {wasteActive,wasteCapacity} from './utilities.js?v=live-scenario-comparisons-2';
import {validateSave,recompute} from './engine.js?v=live-scenario-comparisons-2';
import {serializeCity} from './save.js?v=live-scenario-comparisons-2';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=live-scenario-comparisons-2';
import {healthOutlook} from './health.js?v=live-scenario-comparisons-2';
import {educationTargets} from './education.js?v=live-scenario-comparisons-2';
