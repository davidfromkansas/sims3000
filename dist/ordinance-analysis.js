...
import {wasteActive,wasteCapacity} from './utilities.js?v=architecture-collection-51';
import {validateSave,recompute} from './engine.js?v=architecture-collection-51';
import {serializeCity} from './save.js?v=architecture-collection-51';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=architecture-collection-51';
import {healthOutlook} from './health.js?v=architecture-collection-51';
import {educationTargets} from './education.js?v=architecture-collection-51';
