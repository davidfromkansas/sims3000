import {validateSave,recompute} from './engine.js?v=recent-construction-1';
import {serializeCity} from './save.js?v=recent-construction-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=recent-construction-1';
import {healthOutlook} from './health.js?v=recent-construction-1';
import {educationTargets} from './education.js?v=recent-construction-1';
