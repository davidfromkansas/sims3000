import {utilityTrendSnapshot} from './utility-trends.js?v=power-overload-grace-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=power-overload-grace-1';
import {validateSave,recompute} from './engine.js?v=power-overload-grace-1';
import {serializeCity} from './save.js?v=power-overload-grace-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=power-overload-grace-1';
import {healthOutlook} from './health.js?v=power-overload-grace-1';
import {educationTargets} from './education.js?v=power-overload-grace-1';
