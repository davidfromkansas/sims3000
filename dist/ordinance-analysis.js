import {validateSave,recompute} from './engine.js?v=ordinance-comparison-1';
import {serializeCity} from './save.js?v=ordinance-comparison-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=ordinance-comparison-1';
import {healthOutlook} from './health.js?v=ordinance-comparison-1';
import {educationTargets} from './education.js?v=ordinance-comparison-1';
