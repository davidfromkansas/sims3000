import {utilityTrendSnapshot} from './utility-trends.js?v=university-campus-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=university-campus-1';
import {validateSave,recompute} from './engine.js?v=university-campus-1';
import {serializeCity} from './save.js?v=university-campus-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=university-campus-1';
import {healthOutlook} from './health.js?v=university-campus-1';
import {educationTargets} from './education.js?v=university-campus-1';
