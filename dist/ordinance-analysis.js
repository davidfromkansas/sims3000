import {utilityTrendSnapshot} from './utility-trends.js?v=scenario-variable-manager-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=scenario-variable-manager-1';
import {validateSave,recompute} from './engine.js?v=scenario-variable-manager-1';
import {serializeCity} from './save.js?v=scenario-variable-manager-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=scenario-variable-manager-1';
import {healthOutlook} from './health.js?v=scenario-variable-manager-1';
import {educationTargets} from './education.js?v=scenario-variable-manager-1';
