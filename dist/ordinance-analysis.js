import {utilityTrendSnapshot} from './utility-trends.js?v=east-asian-landmarks-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=east-asian-landmarks-1';
import {validateSave,recompute} from './engine.js?v=east-asian-landmarks-1';
import {serializeCity} from './save.js?v=east-asian-landmarks-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=east-asian-landmarks-1';
import {healthOutlook} from './health.js?v=east-asian-landmarks-1';
import {educationTargets} from './education.js?v=east-asian-landmarks-1';
