...
import {wasteActive,wasteCapacity} from './utilities.js?v=automatic-police-response-1';
import {validateSave,recompute} from './engine.js?v=automatic-police-response-1';
import {serializeCity} from './save.js?v=automatic-police-response-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=automatic-police-response-1';
import {healthOutlook} from './health.js?v=automatic-police-response-1';
import {educationTargets} from './education.js?v=automatic-police-response-1';
