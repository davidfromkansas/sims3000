...
import {wasteActive,wasteCapacity} from './utilities.js?v=hospital-patients-1';
import {validateSave,recompute} from './engine.js?v=hospital-patients-1';
import {serializeCity} from './save.js?v=hospital-patients-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=hospital-patients-1';
import {healthOutlook} from './health.js?v=hospital-patients-1';
import {educationTargets} from './education.js?v=hospital-patients-1';
