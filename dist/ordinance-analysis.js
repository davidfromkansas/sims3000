import {validateSave,recompute} from './engine.js?v=city-hall-1';
import {serializeCity} from './save.js?v=city-hall-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=city-hall-1';
import {healthOutlook} from './health.js?v=city-hall-1';
import {educationTargets} from './education.js?v=city-hall-1';
