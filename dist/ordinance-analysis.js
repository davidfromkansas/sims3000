import {utilityTrendSnapshot} from './utility-trends.js?v=jail-overcrowding-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=jail-overcrowding-1';
import {validateSave,recompute} from './engine.js?v=jail-overcrowding-1';
import {serializeCity} from './save.js?v=jail-overcrowding-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=jail-overcrowding-1';
import {healthOutlook} from './health.js?v=jail-overcrowding-1';
import {educationTargets} from './education.js?v=jail-overcrowding-1';
