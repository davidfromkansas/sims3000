import {utilityTrendSnapshot} from './utility-trends.js?v=science-center-2';
import {wasteActive,wasteCapacity} from './utilities.js?v=science-center-2';
import {validateSave,recompute} from './engine.js?v=science-center-2';
import {serializeCity} from './save.js?v=science-center-2';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=science-center-2';
import {healthOutlook} from './health.js?v=science-center-2';
import {educationTargets} from './education.js?v=science-center-2';
