import {validateSave,recompute} from './engine.js?v=first-repayment-1';
import {serializeCity} from './save.js?v=first-repayment-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=first-repayment-1';
import {healthOutlook} from './health.js?v=first-repayment-1';
import {educationTargets} from './education.js?v=first-repayment-1';
