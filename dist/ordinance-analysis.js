import {validateSave,recompute} from './engine.js?v=shaped-details-1';
import {serializeCity} from './save.js?v=shaped-details-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=shaped-details-1';
import {healthOutlook} from './health.js?v=shaped-details-1';
import {educationTargets} from './education.js?v=shaped-details-1';
