import {utilityTrendSnapshot} from './utility-trends.js?v=police-squad-recall-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=police-squad-recall-1';
import {validateSave,recompute} from './engine.js?v=police-squad-recall-1';
import {serializeCity} from './save.js?v=police-squad-recall-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=police-squad-recall-1';
import {healthOutlook} from './health.js?v=police-squad-recall-1';
import {educationTargets} from './education.js?v=police-squad-recall-1';
