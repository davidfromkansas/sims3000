...
import {wasteActive,wasteCapacity} from './utilities.js?v=medical-research-center-1';
import {validateSave,recompute} from './engine.js?v=medical-research-center-1';
import {serializeCity} from './save.js?v=medical-research-center-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=medical-research-center-1';
import {healthOutlook} from './health.js?v=medical-research-center-1';
import {educationTargets} from './education.js?v=medical-research-center-1';
