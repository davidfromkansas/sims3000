import {utilityTrendSnapshot} from './utility-trends.js?v=fire-land-value-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=fire-land-value-1';
import {validateSave,recompute} from './engine.js?v=fire-land-value-1';
import {serializeCity} from './save.js?v=fire-land-value-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=fire-land-value-1';
import {healthOutlook} from './health.js?v=fire-land-value-1';
import {educationTargets} from './education.js?v=fire-land-value-1';
