...
import {wasteActive,wasteCapacity} from './utilities.js?v=performing-arts-center-1';
import {validateSave,recompute} from './engine.js?v=performing-arts-center-1';
import {serializeCity} from './save.js?v=performing-arts-center-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=performing-arts-center-1';
import {healthOutlook} from './health.js?v=performing-arts-center-1';
import {educationTargets} from './education.js?v=performing-arts-center-1';
