import {utilityTrendSnapshot} from './utility-trends.js?v=courthouse-neighborhood-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=courthouse-neighborhood-1';
import {validateSave,recompute} from './engine.js?v=courthouse-neighborhood-1';
import {serializeCity} from './save.js?v=courthouse-neighborhood-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=courthouse-neighborhood-1';
import {healthOutlook} from './health.js?v=courthouse-neighborhood-1';
import {educationTargets} from './education.js?v=courthouse-neighborhood-1';
