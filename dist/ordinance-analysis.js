import {utilityTrendSnapshot} from './utility-trends.js?v=room-to-grow-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=room-to-grow-1';
import {validateSave,recompute} from './engine.js?v=room-to-grow-1';
import {serializeCity} from './save.js?v=room-to-grow-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=room-to-grow-1';
import {healthOutlook} from './health.js?v=room-to-grow-1';
import {educationTargets} from './education.js?v=room-to-grow-1';
