import {utilityTrendSnapshot} from './utility-trends.js?v=architecture-collection-39';
import {wasteActive,wasteCapacity} from './utilities.js?v=architecture-collection-39';
import {validateSave,recompute} from './engine.js?v=architecture-collection-39';
import {serializeCity} from './save.js?v=architecture-collection-39';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=architecture-collection-39';
import {healthOutlook} from './health.js?v=architecture-collection-39';
import {educationTargets} from './education.js?v=architecture-collection-39';
