import {utilityTrendSnapshot} from './utility-trends.js?v=architecture-collection-41';
import {wasteActive,wasteCapacity} from './utilities.js?v=architecture-collection-41';
import {validateSave,recompute} from './engine.js?v=architecture-collection-41';
import {serializeCity} from './save.js?v=architecture-collection-41';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=architecture-collection-41';
import {healthOutlook} from './health.js?v=architecture-collection-41';
import {educationTargets} from './education.js?v=architecture-collection-41';
