...
import {wasteActive,wasteCapacity} from './utilities.js?v=architecture-collection-55';
import {validateSave,recompute} from './engine.js?v=architecture-collection-55';
import {serializeCity} from './save.js?v=architecture-collection-55';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=architecture-collection-55';
import {healthOutlook} from './health.js?v=architecture-collection-55';
import {educationTargets} from './education.js?v=architecture-collection-55';
