import {validateSave,recompute} from './engine.js?v=sloped-blocks-1';
import {serializeCity} from './save.js?v=sloped-blocks-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=sloped-blocks-1';
import {healthOutlook} from './health.js?v=sloped-blocks-1';
import {educationTargets} from './education.js?v=sloped-blocks-1';
