import {utilityTrendSnapshot} from './utility-trends.js?v=scripted-ending-ranks-1';
import {wasteActive,wasteCapacity} from './utilities.js?v=scripted-ending-ranks-1';
import {validateSave,recompute} from './engine.js?v=scripted-ending-ranks-1';
import {serializeCity} from './save.js?v=scripted-ending-ranks-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=scripted-ending-ranks-1';
import {healthOutlook} from './health.js?v=scripted-ending-ranks-1';
import {educationTargets} from './education.js?v=scripted-ending-ranks-1';
