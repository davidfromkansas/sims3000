import {validateSave,recompute} from './engine.js?v=financial-advisor-1';
import {serializeCity} from './save.js?v=financial-advisor-1';
import {ORDINANCES,changeCivic,civicSpending} from './civic.js?v=financial-advisor-1';
import {healthOutlook} from './health.js?v=financial-advisor-1';
import {educationTargets} from './education.js?v=financial-advisor-1';
