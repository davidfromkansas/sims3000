import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=garbage-health-1';
import {recompute,validateSave} from './engine.js?v=garbage-health-1';
import {serializeCity} from './save.js?v=garbage-health-1';
import {healthOutlook} from './health.js?v=garbage-health-1';
