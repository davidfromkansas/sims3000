import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=local-city-ambience-1';
import {recompute,validateSave} from './engine.js?v=local-city-ambience-1';
import {serializeCity} from './save.js?v=local-city-ambience-1';
import {healthOutlook} from './health.js?v=local-city-ambience-1';
