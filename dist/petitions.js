import {utilityTrendSnapshot} from './utility-trends.js?v=civic-advisors-2';
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=civic-advisors-2';
import {recompute,validateSave} from './engine.js?v=civic-advisors-2';
import {serializeCity} from './save.js?v=civic-advisors-2';
import {healthOutlook} from './health.js?v=civic-advisors-2';
