import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=city-landscape-styles-1';
import {recompute,validateSave} from './engine.js?v=city-landscape-styles-1';
import {serializeCity} from './save.js?v=city-landscape-styles-1';
import {healthOutlook} from './health.js?v=city-landscape-styles-1';
