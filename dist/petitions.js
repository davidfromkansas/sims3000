import {utilityTrendSnapshot} from './utility-trends.js?v=recent-construction-1';
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=recent-construction-1';
import {recompute,validateSave} from './engine.js?v=recent-construction-1';
import {serializeCity} from './save.js?v=recent-construction-1';
import {healthOutlook} from './health.js?v=recent-construction-1';
