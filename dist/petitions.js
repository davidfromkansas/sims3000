import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=scenario-controls-1';
import {recompute,validateSave} from './engine.js?v=scenario-controls-1';
import {serializeCity} from './save.js?v=scenario-controls-1';
import {healthOutlook} from './health.js?v=scenario-controls-1';
