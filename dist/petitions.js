...
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=scenario-variable-manager-1';
import {recompute,validateSave} from './engine.js?v=scenario-variable-manager-1';
