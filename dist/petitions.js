import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=anchored-camera-rotation-1';
import {recompute,validateSave} from './engine.js?v=anchored-camera-rotation-1';
import {serializeCity} from './save.js?v=anchored-camera-rotation-1';
import {healthOutlook} from './health.js?v=anchored-camera-rotation-1';
