import {utilityTrendSnapshot} from './utility-trends.js?v=building-plane-guides-1';
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=building-plane-guides-1';
import {recompute,validateSave} from './engine.js?v=building-plane-guides-1';
import {serializeCity} from './save.js?v=building-plane-guides-1';
import {healthOutlook} from './health.js?v=building-plane-guides-1';
