import {utilityTrendSnapshot} from './utility-trends.js?v=playtest-checkpoints-2';
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=playtest-checkpoints-2';
import {recompute,validateSave} from './engine.js?v=playtest-checkpoints-2';
import {serializeCity} from './save.js?v=playtest-checkpoints-2';
import {healthOutlook} from './health.js?v=playtest-checkpoints-2';
