import {utilityTrendSnapshot} from './utility-trends.js?v=abandoned-recovery-1';
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=abandoned-recovery-1';
import {recompute,validateSave} from './engine.js?v=abandoned-recovery-1';
