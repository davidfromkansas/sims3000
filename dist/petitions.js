import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=background-months-1';
import {recompute,validateSave} from './engine.js?v=background-months-1';
import {serializeCity} from './save.js?v=background-months-1';
import {healthOutlook} from './health.js?v=background-months-1';
