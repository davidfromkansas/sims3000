import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=landmark-collection-1';
import {recompute,validateSave} from './engine.js?v=landmark-collection-1';
import {serializeCity} from './save.js?v=landmark-collection-1';
import {healthOutlook} from './health.js?v=landmark-collection-1';
