...
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=architecture-workspace-1';
import {recompute,validateSave} from './engine.js?v=architecture-workspace-1';
