import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=variable-maps-1';
import {recompute,validateSave} from './engine.js?v=variable-maps-1';
import {serializeCity} from './save.js?v=variable-maps-1';
