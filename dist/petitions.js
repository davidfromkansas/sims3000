import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=pedestrians-1';
import {recompute,validateSave} from './engine.js?v=pedestrians-1';
import {serializeCity} from './save.js?v=pedestrians-1';
import {healthOutlook} from './health.js?v=pedestrians-1';
