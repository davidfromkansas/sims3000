...
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=automatic-police-response-1';
import {recompute,validateSave} from './engine.js?v=automatic-police-response-1';
