import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=policy-petitions-1';
import {recompute,validateSave} from './engine.js?v=policy-petitions-1';
import {serializeCity} from './save.js?v=policy-petitions-1';
import {healthOutlook} from './health.js?v=policy-petitions-1';
