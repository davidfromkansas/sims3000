import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=scenario-dialog-text-1';
import {recompute,validateSave} from './engine.js?v=scenario-dialog-text-1';
import {serializeCity} from './save.js?v=scenario-dialog-text-1';
