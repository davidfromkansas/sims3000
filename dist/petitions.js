import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=visible-garbage-backlog-1';
import {recompute,validateSave} from './engine.js?v=visible-garbage-backlog-1';
import {serializeCity} from './save.js?v=visible-garbage-backlog-1';
import {healthOutlook} from './health.js?v=visible-garbage-backlog-1';
