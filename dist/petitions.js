...
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=architecture-collection-53';
import {recompute,validateSave} from './engine.js?v=architecture-collection-53';
