import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=scenario-neighbor-deals-1';
import {recompute,validateSave} from './engine.js?v=scenario-neighbor-deals-1';
import {serializeCity} from './save.js?v=scenario-neighbor-deals-1';
import {healthOutlook} from './health.js?v=scenario-neighbor-deals-1';
