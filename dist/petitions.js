...
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=first-repayment-1';
import {recompute,validateSave} from './engine.js?v=first-repayment-1';
import {serializeCity} from './save.js?v=first-repayment-1';
import {healthOutlook} from './health.js?v=first-repayment-1';
