import {utilityTrendSnapshot} from './utility-trends.js?v=navigation-cache-1';
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=navigation-cache-1';
import {recompute,validateSave} from './engine.js?v=navigation-cache-1';
import {serializeCity} from './save.js?v=navigation-cache-1';
import {healthOutlook} from './health.js?v=navigation-cache-1';
