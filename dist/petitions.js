import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=power-grids-1';
import {recompute,validateSave} from './engine.js?v=power-grids-1';
import {serializeCity} from './save.js?v=power-grids-1';
import {healthOutlook} from './health.js?v=power-grids-1';
