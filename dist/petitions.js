import {utilityTrendSnapshot} from './utility-trends.js?v=ordinance-comparison-1';
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=ordinance-comparison-1';
import {recompute,validateSave} from './engine.js?v=ordinance-comparison-1';
import {serializeCity} from './save.js?v=ordinance-comparison-1';
import {healthOutlook} from './health.js?v=ordinance-comparison-1';
