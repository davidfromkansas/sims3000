import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=available-job-targets-1';
import {recompute,validateSave} from './engine.js?v=available-job-targets-1';
import {serializeCity} from './save.js?v=available-job-targets-1';
import {healthOutlook} from './health.js?v=available-job-targets-1';
