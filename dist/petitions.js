import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=goal-status-1';
import {recompute,validateSave} from './engine.js?v=goal-status-1';
import {serializeCity} from './save.js?v=goal-status-1';
import {healthOutlook} from './health.js?v=goal-status-1';
