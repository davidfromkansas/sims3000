import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=concurrent-disasters-1';
import {recompute,validateSave} from './engine.js?v=concurrent-disasters-1';
import {serializeCity} from './save.js?v=concurrent-disasters-1';
import {healthOutlook} from './health.js?v=concurrent-disasters-1';
