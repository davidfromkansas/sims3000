import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=goal-activation-1';
import {recompute,validateSave} from './engine.js?v=goal-activation-1';
import {serializeCity} from './save.js?v=goal-activation-1';
import {healthOutlook} from './health.js?v=goal-activation-1';
