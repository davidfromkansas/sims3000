import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=new-city-artwork-1';
import {recompute,validateSave} from './engine.js?v=new-city-artwork-1';
import {serializeCity} from './save.js?v=new-city-artwork-1';
import {healthOutlook} from './health.js?v=new-city-artwork-1';
