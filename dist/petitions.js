import {utilityTrendSnapshot} from './utility-trends.js?v=plane-navigation-1';
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=plane-navigation-1';
import {recompute,validateSave} from './engine.js?v=plane-navigation-1';
import {serializeCity} from './save.js?v=plane-navigation-1';
import {healthOutlook} from './health.js?v=plane-navigation-1';
