import {utilityTrendSnapshot} from './utility-trends.js?v=abandonment-history-1';
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=abandonment-history-1';
import {recompute,validateSave} from './engine.js?v=abandonment-history-1';
import {serializeCity} from './save.js?v=abandonment-history-1';
import {healthOutlook} from './health.js?v=abandonment-history-1';
