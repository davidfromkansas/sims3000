import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=power-models-1';
import {recompute,validateSave} from './engine.js?v=power-models-1';
import {serializeCity} from './save.js?v=power-models-1';
import {healthOutlook} from './health.js?v=power-models-1';
