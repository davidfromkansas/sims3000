import {utilityTrendSnapshot} from './utility-trends.js?v=civic-employment-1';
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=civic-employment-1';
import {recompute,validateSave} from './engine.js?v=civic-employment-1';
import {serializeCity} from './save.js?v=civic-employment-1';
import {healthOutlook} from './health.js?v=civic-employment-1';
