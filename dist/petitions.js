...
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=sloped-blocks-1';
import {recompute,validateSave} from './engine.js?v=sloped-blocks-1';
import {serializeCity} from './save.js?v=sloped-blocks-1';
import {healthOutlook} from './health.js?v=sloped-blocks-1';
