...
import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=architecture-collection-39';
import {recompute,validateSave} from './engine.js?v=architecture-collection-39';
