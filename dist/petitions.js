import {ORDINANCES,changeCivic,ordinanceCost} from './civic.js?v=emergency-order-1';
import {recompute,validateSave} from './engine.js?v=emergency-order-1';
import {serializeCity} from './save.js?v=emergency-order-1';
import {healthOutlook} from './health.js?v=emergency-order-1';
