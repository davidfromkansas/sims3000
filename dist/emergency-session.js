import {beginReliefAssessment} from './disaster-relief.js?v=scenario-variable-manager-1';
import {freshEmergencyOrder} from './emergency-order.js?v=scenario-variable-manager-1';
