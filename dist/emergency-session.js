import {beginReliefAssessment} from './disaster-relief.js?v=scenario-dialog-text-1';
import {freshEmergencyOrder} from './emergency-order.js?v=scenario-dialog-text-1';
