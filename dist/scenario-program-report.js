import {dialogTextTarget} from './scenario-dialog-text.js?v=architecture-collection-57';
import {tornadoSettingsLabel} from './tornado-settings.js?v=architecture-collection-57';
import {neighborDealLabel,neighborDealResultText} from './scenario-neighbor-deals.js?v=architecture-collection-57';
import {compileGameScenarioPrograms} from './scenario-program-definitions.js?v=architecture-collection-57';
import {programActionSources,pendingProgramMessage,programInvocationFinished} from './scenario-program-history.js?v=architecture-collection-57';
import {SCENARIO_EVENTS,eventConditionLabel} from './scenario-events.js?v=architecture-collection-57';
import {startScenarioProgram,nextScenarioProgramAction} from './scenario-programs.js?v=architecture-collection-57';
import {escapeAnnouncement} from './scenario-announcements.js?v=architecture-collection-57';
