import {dialogTextTarget} from './scenario-dialog-text.js?v=responsive-metropolis-3';
import {tornadoSettingsLabel} from './tornado-settings.js?v=responsive-metropolis-3';
import {neighborDealLabel,neighborDealResultText} from './scenario-neighbor-deals.js?v=responsive-metropolis-3';
import {compileGameScenarioPrograms} from './scenario-program-definitions.js?v=responsive-metropolis-3';
import {programActionSources,pendingProgramMessage,programInvocationFinished} from './scenario-program-history.js?v=responsive-metropolis-3';
import {SCENARIO_EVENTS,eventConditionLabel} from './scenario-events.js?v=responsive-metropolis-3';
import {startScenarioProgram,nextScenarioProgramAction} from './scenario-programs.js?v=responsive-metropolis-3';
import {escapeAnnouncement} from './scenario-announcements.js?v=responsive-metropolis-3';
