import {neighborDealLabel,neighborDealResultText} from './scenario-neighbor-deals.js?v=earthquake-magnitude-1';
import {compileGameScenarioPrograms} from './scenario-program-definitions.js?v=earthquake-magnitude-1';
import {programActionSources,pendingProgramMessage,programInvocationFinished} from './scenario-program-history.js?v=earthquake-magnitude-1';
import {SCENARIO_EVENTS,eventConditionLabel} from './scenario-events.js?v=earthquake-magnitude-1';
import {startScenarioProgram,nextScenarioProgramAction} from './scenario-programs.js?v=earthquake-magnitude-1';
import {escapeAnnouncement} from './scenario-announcements.js?v=earthquake-magnitude-1';
