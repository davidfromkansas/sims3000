import {dialogTextTarget} from './scenario-dialog-text.js?v=science-center-2';
import {tornadoSettingsLabel} from './tornado-settings.js?v=science-center-2';
import {neighborDealLabel,neighborDealResultText} from './scenario-neighbor-deals.js?v=science-center-2';
import {compileGameScenarioPrograms} from './scenario-program-definitions.js?v=science-center-2';
import {programActionSources,pendingProgramMessage,programInvocationFinished} from './scenario-program-history.js?v=science-center-2';
import {SCENARIO_EVENTS,eventConditionLabel} from './scenario-events.js?v=science-center-2';
import {startScenarioProgram,nextScenarioProgramAction} from './scenario-programs.js?v=science-center-2';
import {escapeAnnouncement} from './scenario-announcements.js?v=science-center-2';
