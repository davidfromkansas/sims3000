import {isCivicRoot} from './civic-footprints.js?v=stock-exchange-1';
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=stock-exchange-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=stock-exchange-1';
