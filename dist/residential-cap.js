import {isCivicRoot} from './civic-footprints.js?v=automatic-police-response-1';
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=automatic-police-response-1';
