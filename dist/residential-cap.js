import {isCivicRoot} from './civic-footprints.js?v=scenario-variable-manager-1';
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=scenario-variable-manager-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=scenario-variable-manager-1';
