import {isCivicRoot} from './civic-footprints.js?v=geyser-park-1';
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=geyser-park-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=geyser-park-1';
