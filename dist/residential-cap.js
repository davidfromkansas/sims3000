import {isCivicRoot} from './civic-footprints.js?v=civic-garbage-1';
import {REWARDS,rewardRoots,rewardActive} from './rewards.js?v=civic-garbage-1';
import {RECREATION,recreationRoots,recreationActive} from './recreation.js?v=civic-garbage-1';
