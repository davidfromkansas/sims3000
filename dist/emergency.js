import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=background-months-1';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=background-months-1';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=background-months-1';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=background-months-1';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=background-months-1';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=background-months-1';
import {tunnelTiles} from './tunnels.js?v=background-months-1';
import {STRUCTURES} from './structures.js?v=background-months-1';
import {POWER_PLANTS} from './power.js?v=background-months-1';
import {occupancy} from './utilities.js?v=background-months-1';
