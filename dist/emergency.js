import {validateTornadoSettings,tornadoVector,validateTornadoMotion} from './tornado-settings.js?v=neighborhood-aura-1';
import {DEFAULT_QUAKE_MAGNITUDE,validateQuakeMagnitude,quakeBands,quakeDamageChance} from './earthquake-settings.js?v=neighborhood-aura-1';
import {dissolveBuildingLot} from './building-lots.js?v=neighborhood-aura-1';
import {freshDisasterRelief,settleDisasterRelief,validateDisasterRelief} from './disaster-relief.js?v=neighborhood-aura-1';
import {scenarioAllowsBackground} from './scenario-background-rules.js?v=neighborhood-aura-1';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=neighborhood-aura-1';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=neighborhood-aura-1';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=neighborhood-aura-1';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=neighborhood-aura-1';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=neighborhood-aura-1';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=neighborhood-aura-1';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=neighborhood-aura-1';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=neighborhood-aura-1';
import {tunnelTiles} from './tunnels.js?v=neighborhood-aura-1';
import {STRUCTURES} from './structures.js?v=neighborhood-aura-1';
import {POWER_PLANTS} from './power.js?v=neighborhood-aura-1';
