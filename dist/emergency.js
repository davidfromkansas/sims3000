import {civicRoots,civicIntact} from './civic-footprints.js?v=architecture-collection-55';
import {validateTornadoSettings,tornadoVector,validateTornadoMotion} from './tornado-settings.js?v=architecture-collection-55';
import {DEFAULT_QUAKE_MAGNITUDE,validateQuakeMagnitude,quakeBands,quakeDamageChance} from './earthquake-settings.js?v=architecture-collection-55';
import {dissolveBuildingLot} from './building-lots.js?v=architecture-collection-55';
import {freshDisasterRelief,settleDisasterRelief,validateDisasterRelief} from './disaster-relief.js?v=architecture-collection-55';
import {scenarioAllowsBackground} from './scenario-background-rules.js?v=architecture-collection-55';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=architecture-collection-55';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=architecture-collection-55';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=architecture-collection-55';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=architecture-collection-55';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=architecture-collection-55';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=architecture-collection-55';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=architecture-collection-55';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=architecture-collection-55';
import {tunnelTiles} from './tunnels.js?v=architecture-collection-55';
import {STRUCTURES} from './structures.js?v=architecture-collection-55';
import {POWER_PLANTS} from './power.js?v=architecture-collection-55';
