import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=expanding-farms-1';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=expanding-farms-1';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=expanding-farms-1';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=expanding-farms-1';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=expanding-farms-1';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=expanding-farms-1';
import {tunnelTiles} from './tunnels.js?v=expanding-farms-1';
import {STRUCTURES} from './structures.js?v=expanding-farms-1';
import {POWER_PLANTS} from './power.js?v=expanding-farms-1';
import {occupancy} from './utilities.js?v=expanding-farms-1';
