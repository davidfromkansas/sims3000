import {validateTornadoSettings,tornadoVector,validateTornadoMotion} from './tornado-settings.js?v=direct-model-paint-2';
import {DEFAULT_QUAKE_MAGNITUDE,validateQuakeMagnitude,quakeBands,quakeDamageChance} from './earthquake-settings.js?v=direct-model-paint-2';
import {dissolveBuildingLot} from './building-lots.js?v=direct-model-paint-2';
import {freshDisasterRelief,settleDisasterRelief,validateDisasterRelief} from './disaster-relief.js?v=direct-model-paint-2';
import {scenarioAllowsBackground} from './scenario-background-rules.js?v=direct-model-paint-2';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=direct-model-paint-2';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=direct-model-paint-2';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=direct-model-paint-2';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=direct-model-paint-2';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=direct-model-paint-2';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=direct-model-paint-2';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=direct-model-paint-2';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=direct-model-paint-2';
import {tunnelTiles} from './tunnels.js?v=direct-model-paint-2';
import {STRUCTURES} from './structures.js?v=direct-model-paint-2';
import {POWER_PLANTS} from './power.js?v=direct-model-paint-2';
