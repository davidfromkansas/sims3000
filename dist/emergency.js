import {dissolveBuildingLot} from './building-lots.js?v=new-city-artwork-1';
import {freshDisasterRelief,settleDisasterRelief,validateDisasterRelief} from './disaster-relief.js?v=new-city-artwork-1';
import {scenarioAllowsBackground} from './scenario-background-rules.js?v=new-city-artwork-1';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=new-city-artwork-1';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=new-city-artwork-1';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=new-city-artwork-1';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=new-city-artwork-1';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=new-city-artwork-1';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=new-city-artwork-1';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=new-city-artwork-1';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=new-city-artwork-1';
import {tunnelTiles} from './tunnels.js?v=new-city-artwork-1';
import {STRUCTURES} from './structures.js?v=new-city-artwork-1';
import {POWER_PLANTS} from './power.js?v=new-city-artwork-1';
import {occupancy} from './utilities.js?v=new-city-artwork-1';
