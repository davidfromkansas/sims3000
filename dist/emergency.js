import {dissolveBuildingLot} from './building-lots.js?v=multi-neighbor-trade-1';
import {freshDisasterRelief,settleDisasterRelief,validateDisasterRelief} from './disaster-relief.js?v=multi-neighbor-trade-1';
import {scenarioAllowsBackground} from './scenario-background-rules.js?v=multi-neighbor-trade-1';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=multi-neighbor-trade-1';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=multi-neighbor-trade-1';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=multi-neighbor-trade-1';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=multi-neighbor-trade-1';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=multi-neighbor-trade-1';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=multi-neighbor-trade-1';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=multi-neighbor-trade-1';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=multi-neighbor-trade-1';
import {tunnelTiles} from './tunnels.js?v=multi-neighbor-trade-1';
import {STRUCTURES} from './structures.js?v=multi-neighbor-trade-1';
import {POWER_PLANTS} from './power.js?v=multi-neighbor-trade-1';
