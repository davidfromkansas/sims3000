import {validateTornadoSettings,tornadoVector,validateTornadoMotion} from './tornado-settings.js?v=business-site-analysis-2';
import {DEFAULT_QUAKE_MAGNITUDE,validateQuakeMagnitude,quakeBands,quakeDamageChance} from './earthquake-settings.js?v=business-site-analysis-2';
import {dissolveBuildingLot} from './building-lots.js?v=business-site-analysis-2';
import {freshDisasterRelief,settleDisasterRelief,validateDisasterRelief} from './disaster-relief.js?v=business-site-analysis-2';
import {scenarioAllowsBackground} from './scenario-background-rules.js?v=business-site-analysis-2';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=business-site-analysis-2';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=business-site-analysis-2';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=business-site-analysis-2';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=business-site-analysis-2';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=business-site-analysis-2';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=business-site-analysis-2';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=business-site-analysis-2';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=business-site-analysis-2';
import {tunnelTiles} from './tunnels.js?v=business-site-analysis-2';
import {STRUCTURES} from './structures.js?v=business-site-analysis-2';
