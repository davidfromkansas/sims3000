import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=emergency-navigation-1';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=emergency-navigation-1';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=emergency-navigation-1';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=emergency-navigation-1';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=emergency-navigation-1';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=emergency-navigation-1';
import {tunnelTiles} from './tunnels.js?v=emergency-navigation-1';
