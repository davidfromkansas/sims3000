import {validateTornadoSettings,tornadoVector,validateTornadoMotion} from './tornado-settings.js?v=building-vertical-planes-1';
import {DEFAULT_QUAKE_MAGNITUDE,validateQuakeMagnitude,quakeBands,quakeDamageChance} from './earthquake-settings.js?v=building-vertical-planes-1';
import {dissolveBuildingLot} from './building-lots.js?v=building-vertical-planes-1';
import {freshDisasterRelief,settleDisasterRelief,validateDisasterRelief} from './disaster-relief.js?v=building-vertical-planes-1';
import {scenarioAllowsBackground} from './scenario-background-rules.js?v=building-vertical-planes-1';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=building-vertical-planes-1';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=building-vertical-planes-1';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=building-vertical-planes-1';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=building-vertical-planes-1';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=building-vertical-planes-1';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=building-vertical-planes-1';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=building-vertical-planes-1';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=building-vertical-planes-1';
import {tunnelTiles} from './tunnels.js?v=building-vertical-planes-1';
import {STRUCTURES} from './structures.js?v=building-vertical-planes-1';
import {POWER_PLANTS} from './power.js?v=building-vertical-planes-1';
import {occupancy} from './utilities.js?v=building-vertical-planes-1';
