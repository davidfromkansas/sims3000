import {civicRoots,civicIntact} from './civic-footprints.js?v=responsive-metropolis-3';
import {validateTornadoSettings,tornadoVector,validateTornadoMotion} from './tornado-settings.js?v=responsive-metropolis-3';
import {DEFAULT_QUAKE_MAGNITUDE,validateQuakeMagnitude,quakeBands,quakeDamageChance} from './earthquake-settings.js?v=responsive-metropolis-3';
import {dissolveBuildingLot} from './building-lots.js?v=responsive-metropolis-3';
import {freshDisasterRelief,settleDisasterRelief,validateDisasterRelief} from './disaster-relief.js?v=responsive-metropolis-3';
import {scenarioAllowsBackground} from './scenario-background-rules.js?v=responsive-metropolis-3';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=responsive-metropolis-3';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=responsive-metropolis-3';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=responsive-metropolis-3';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=responsive-metropolis-3';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=responsive-metropolis-3';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=responsive-metropolis-3';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=responsive-metropolis-3';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=responsive-metropolis-3';
import {tunnelTiles} from './tunnels.js?v=responsive-metropolis-3';
import {STRUCTURES} from './structures.js?v=responsive-metropolis-3';
