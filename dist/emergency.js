import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=large-city-performance-1';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=large-city-performance-1';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=large-city-performance-1';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=large-city-performance-1';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=large-city-performance-1';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=large-city-performance-1';
import {tunnelTiles} from './tunnels.js?v=large-city-performance-1';
import {STRUCTURES} from './structures.js?v=large-city-performance-1';
