import {validateTornadoSettings,tornadoVector,validateTornadoMotion} from './tornado-settings.js?v=zone-growth-1';
import {DEFAULT_QUAKE_MAGNITUDE,validateQuakeMagnitude,quakeBands,quakeDamageChance} from './earthquake-settings.js?v=zone-growth-1';
import {dissolveBuildingLot} from './building-lots.js?v=zone-growth-1';
import {freshDisasterRelief,settleDisasterRelief,validateDisasterRelief} from './disaster-relief.js?v=zone-growth-1';
import {scenarioAllowsBackground} from './scenario-background-rules.js?v=zone-growth-1';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=zone-growth-1';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=zone-growth-1';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=zone-growth-1';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=zone-growth-1';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=zone-growth-1';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=zone-growth-1';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=zone-growth-1';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=zone-growth-1';
import {tunnelTiles} from './tunnels.js?v=zone-growth-1';
import {STRUCTURES} from './structures.js?v=zone-growth-1';
import {POWER_PLANTS} from './power.js?v=zone-growth-1';
import {occupancy} from './utilities.js?v=zone-growth-1';
