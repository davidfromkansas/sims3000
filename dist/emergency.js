import {scenarioAllowsBackground} from './scenario-background-rules.js?v=neighborhood-designs-1';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=neighborhood-designs-1';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=neighborhood-designs-1';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=neighborhood-designs-1';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=neighborhood-designs-1';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=neighborhood-designs-1';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=neighborhood-designs-1';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=neighborhood-designs-1';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=neighborhood-designs-1';
import {tunnelTiles} from './tunnels.js?v=neighborhood-designs-1';
