import {dissolveBuildingLot} from './building-lots.js?v=education-service-maps-1';
import {freshDisasterRelief,settleDisasterRelief,validateDisasterRelief} from './disaster-relief.js?v=education-service-maps-1';
import {scenarioAllowsBackground} from './scenario-background-rules.js?v=education-service-maps-1';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=education-service-maps-1';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=education-service-maps-1';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=education-service-maps-1';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=education-service-maps-1';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=education-service-maps-1';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=education-service-maps-1';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=education-service-maps-1';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=education-service-maps-1';
import {tunnelTiles} from './tunnels.js?v=education-service-maps-1';
...
import {occupancy} from './utilities.js?v=education-service-maps-1';
