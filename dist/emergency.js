import {civicRoots,civicIntact} from './civic-footprints.js?v=architecture-collection-41';
import {validateTornadoSettings,tornadoVector,validateTornadoMotion} from './tornado-settings.js?v=architecture-collection-41';
import {DEFAULT_QUAKE_MAGNITUDE,validateQuakeMagnitude,quakeBands,quakeDamageChance} from './earthquake-settings.js?v=architecture-collection-41';
import {dissolveBuildingLot} from './building-lots.js?v=architecture-collection-41';
import {freshDisasterRelief,settleDisasterRelief,validateDisasterRelief} from './disaster-relief.js?v=architecture-collection-41';
import {scenarioAllowsBackground} from './scenario-background-rules.js?v=architecture-collection-41';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=architecture-collection-41';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=architecture-collection-41';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=architecture-collection-41';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=architecture-collection-41';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=architecture-collection-41';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=architecture-collection-41';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=architecture-collection-41';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=architecture-collection-41';
import {tunnelTiles} from './tunnels.js?v=architecture-collection-41';
import {STRUCTURES} from './structures.js?v=architecture-collection-41';
