import {civicRoots,civicIntact} from './civic-footprints.js?v=architecture-collection-48';
import {validateTornadoSettings,tornadoVector,validateTornadoMotion} from './tornado-settings.js?v=architecture-collection-48';
import {DEFAULT_QUAKE_MAGNITUDE,validateQuakeMagnitude,quakeBands,quakeDamageChance} from './earthquake-settings.js?v=architecture-collection-48';
import {dissolveBuildingLot} from './building-lots.js?v=architecture-collection-48';
import {freshDisasterRelief,settleDisasterRelief,validateDisasterRelief} from './disaster-relief.js?v=architecture-collection-48';
import {scenarioAllowsBackground} from './scenario-background-rules.js?v=architecture-collection-48';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=architecture-collection-48';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=architecture-collection-48';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=architecture-collection-48';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=architecture-collection-48';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=architecture-collection-48';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=architecture-collection-48';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=architecture-collection-48';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=architecture-collection-48';
import {tunnelTiles} from './tunnels.js?v=architecture-collection-48';
import {STRUCTURES} from './structures.js?v=architecture-collection-48';
import {POWER_PLANTS} from './power.js?v=architecture-collection-48';
import {occupancy} from './utilities.js?v=architecture-collection-48';
