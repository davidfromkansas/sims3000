import {validateTornadoSettings,tornadoVector,validateTornadoMotion} from './tornado-settings.js?v=underground-water-reading-2';
import {DEFAULT_QUAKE_MAGNITUDE,validateQuakeMagnitude,quakeBands,quakeDamageChance} from './earthquake-settings.js?v=underground-water-reading-2';
import {dissolveBuildingLot} from './building-lots.js?v=underground-water-reading-2';
import {freshDisasterRelief,settleDisasterRelief,validateDisasterRelief} from './disaster-relief.js?v=underground-water-reading-2';
import {scenarioAllowsBackground} from './scenario-background-rules.js?v=underground-water-reading-2';
import {freshEmergencyOrder,recordHazard,recordFire,validateEmergencyOrder} from './emergency-order.js?v=underground-water-reading-2';
import {beginEmergencySession,pendingWarnings,refreshShelter,validateHazardWarning} from './emergency-session.js?v=underground-water-reading-2';
import {freshUfo,stepUfo,validateUfo} from './ufo.js?v=underground-water-reading-2';
import {freshWhirlpool,stepWhirlpool,validateWhirlpool} from './whirlpool.js?v=underground-water-reading-2';
import {freshToxicCloud,stepToxicCloud,validateToxicCloud} from './toxic-cloud.js?v=underground-water-reading-2';
import {freshSpaceJunk,stepSpaceJunk,validateSpaceJunk} from './space-junk.js?v=underground-water-reading-2';
import {freshRiots,stepRiot,validateRiots} from './riots.js?v=underground-water-reading-2';
import {freshLocusts,stepLocusts,validateLocusts} from './locusts.js?v=underground-water-reading-2';
import {tunnelTiles} from './tunnels.js?v=underground-water-reading-2';
import {STRUCTURES} from './structures.js?v=underground-water-reading-2';
import {POWER_PLANTS} from './power.js?v=underground-water-reading-2';
import {occupancy} from './utilities.js?v=underground-water-reading-2';
