...
import {SERVICES} from './civic.js?v=port-garbage-1';
import {STATIONS} from './rail.js?v=port-garbage-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=port-garbage-1';
import {FACILITIES} from './facilities.js?v=port-garbage-1';
