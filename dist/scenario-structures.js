...
import {SERVICES} from './civic.js?v=goal-activation-1';
import {STATIONS} from './rail.js?v=goal-activation-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=goal-activation-1';
import {FACILITIES} from './facilities.js?v=goal-activation-1';
