...
import {SERVICES} from './civic.js?v=ordinance-comparison-1';
import {STATIONS} from './rail.js?v=ordinance-comparison-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=ordinance-comparison-1';
import {FACILITIES} from './facilities.js?v=ordinance-comparison-1';
