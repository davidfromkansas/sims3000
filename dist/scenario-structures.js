...
import {SERVICES} from './civic.js?v=large-city-routing-1';
import {STATIONS} from './rail.js?v=large-city-routing-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=large-city-routing-1';
import {FACILITIES} from './facilities.js?v=large-city-routing-1';
