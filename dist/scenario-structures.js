...
import {SERVICES} from './civic.js?v=background-months-1';
import {STATIONS} from './rail.js?v=background-months-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=background-months-1';
import {FACILITIES} from './facilities.js?v=background-months-1';
