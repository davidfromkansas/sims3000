...
import {SERVICES} from './civic.js?v=civic-inspection-1';
import {STATIONS} from './rail.js?v=civic-inspection-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=civic-inspection-1';
import {FACILITIES} from './facilities.js?v=civic-inspection-1';
import {inScenarioArea} from './scenario-area.js?v=civic-inspection-1';
