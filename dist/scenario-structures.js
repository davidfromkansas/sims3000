...
import {SERVICES} from './civic.js?v=building-shape-tools-1';
import {STATIONS} from './rail.js?v=building-shape-tools-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=building-shape-tools-1';
import {FACILITIES} from './facilities.js?v=building-shape-tools-1';
