...
import {SERVICES} from './civic.js?v=available-job-targets-1';
import {STATIONS} from './rail.js?v=available-job-targets-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=available-job-targets-1';
import {FACILITIES} from './facilities.js?v=available-job-targets-1';
