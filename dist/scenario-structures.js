...
import {SERVICES} from './civic.js?v=fire-coverage-1';
import {STATIONS} from './rail.js?v=fire-coverage-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=fire-coverage-1';
import {FACILITIES} from './facilities.js?v=fire-coverage-1';
