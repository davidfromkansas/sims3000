...
import {SERVICES} from './civic.js?v=keyboard-cursor-1';
import {STATIONS} from './rail.js?v=keyboard-cursor-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=keyboard-cursor-1';
import {FACILITIES} from './facilities.js?v=keyboard-cursor-1';
