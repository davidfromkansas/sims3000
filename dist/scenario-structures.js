...
import {SERVICES} from './civic.js?v=water-grid-report-1';
import {STATIONS} from './rail.js?v=water-grid-report-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=water-grid-report-1';
import {FACILITIES} from './facilities.js?v=water-grid-report-1';
