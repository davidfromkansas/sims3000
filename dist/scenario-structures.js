...
import {SERVICES} from './civic.js?v=transport-advisor-1';
import {STATIONS} from './rail.js?v=transport-advisor-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=transport-advisor-1';
import {FACILITIES} from './facilities.js?v=transport-advisor-1';
