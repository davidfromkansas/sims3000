...
import {SERVICES} from './civic.js?v=policy-petitions-1';
import {STATIONS} from './rail.js?v=policy-petitions-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=policy-petitions-1';
import {FACILITIES} from './facilities.js?v=policy-petitions-1';
