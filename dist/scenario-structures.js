...
import {SERVICES} from './civic.js?v=variable-maps-1';
import {STATIONS} from './rail.js?v=variable-maps-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=variable-maps-1';
import {FACILITIES} from './facilities.js?v=variable-maps-1';
