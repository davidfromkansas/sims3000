...
import {SERVICES} from './civic.js?v=architecture-collection-53';
import {STATIONS} from './rail.js?v=architecture-collection-53';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=architecture-collection-53';
import {FACILITIES} from './facilities.js?v=architecture-collection-53';
