...
import {SERVICES} from './civic.js?v=abandonment-history-1';
import {STATIONS} from './rail.js?v=abandonment-history-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=abandonment-history-1';
import {FACILITIES} from './facilities.js?v=abandonment-history-1';
