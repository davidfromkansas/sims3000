...
import {SERVICES} from './civic.js?v=wind-motion-1';
import {STATIONS} from './rail.js?v=wind-motion-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=wind-motion-1';
import {FACILITIES} from './facilities.js?v=wind-motion-1';
