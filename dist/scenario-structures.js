...
import {SERVICES} from './civic.js?v=architecture-collection-48';
import {STATIONS} from './rail.js?v=architecture-collection-48';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=architecture-collection-48';
import {FACILITIES} from './facilities.js?v=architecture-collection-48';
