...
import {SERVICES} from './civic.js?v=script-clipboard-2';
import {STATIONS} from './rail.js?v=script-clipboard-2';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=script-clipboard-2';
import {FACILITIES} from './facilities.js?v=script-clipboard-2';
