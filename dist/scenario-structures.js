...
import {SERVICES} from './civic.js?v=scenario-programs-1';
import {STATIONS} from './rail.js?v=scenario-programs-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=scenario-programs-1';
import {FACILITIES} from './facilities.js?v=scenario-programs-1';
