...
import {SERVICES} from './civic.js?v=emergency-navigation-1';
import {STATIONS} from './rail.js?v=emergency-navigation-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=emergency-navigation-1';
import {FACILITIES} from './facilities.js?v=emergency-navigation-1';
import {inScenarioArea} from './scenario-area.js?v=emergency-navigation-1';
