...
import {SERVICES} from './civic.js?v=multi-neighbor-trade-1';
import {STATIONS} from './rail.js?v=multi-neighbor-trade-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=multi-neighbor-trade-1';
import {FACILITIES} from './facilities.js?v=multi-neighbor-trade-1';
