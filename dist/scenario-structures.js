...
import {SERVICES} from './civic.js?v=power-allocation-1';
import {STATIONS} from './rail.js?v=power-allocation-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=power-allocation-1';
import {FACILITIES} from './facilities.js?v=power-allocation-1';
