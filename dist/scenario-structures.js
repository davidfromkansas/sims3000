...
import {SERVICES} from './civic.js?v=new-city-artwork-1';
import {STATIONS} from './rail.js?v=new-city-artwork-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=new-city-artwork-1';
import {FACILITIES} from './facilities.js?v=new-city-artwork-1';
