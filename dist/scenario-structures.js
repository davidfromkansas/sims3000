...
import {SERVICES} from './civic.js?v=direct-model-paint-2';
import {STATIONS} from './rail.js?v=direct-model-paint-2';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=direct-model-paint-2';
import {FACILITIES} from './facilities.js?v=direct-model-paint-2';
