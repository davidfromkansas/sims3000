...
import {SERVICES} from './civic.js?v=first-repayment-1';
import {STATIONS} from './rail.js?v=first-repayment-1';
import {WATER_STRUCTURES,WASTE_STRUCTURES} from './utilities.js?v=first-repayment-1';
import {FACILITIES} from './facilities.js?v=first-repayment-1';
