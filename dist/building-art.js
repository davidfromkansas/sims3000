import {buildingSlot,parseBuildingSlot,tileBuildingFootprint} from './building-footprints.js?v=architecture-collection-22';
import {tileIndex} from './city-grid.js?v=architecture-collection-22';
