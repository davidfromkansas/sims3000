...
export function baseZonedSprite(t,seed){
 ...
 return t.industry==='farm'?(t.farmRoot===t.y*48+t.x?52:53):t.industry==='clean'?[54,54,55,56][level]:[6,6,7,8][level];
}
...
export function replaceBuildingStyle(c,source,target){const next=validateBuildingReplacements({...c.buildingReplacements,[source]:target});c.buildingReplacements=next;}
