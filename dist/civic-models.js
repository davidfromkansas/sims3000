import {projectMiniature as projectCivic,rasterizeMiniature} from './miniature-raster.js?v=port-garbage-1';
export {projectMiniature as projectCivic} from './miniature-raster.js?v=port-garbage-1';
