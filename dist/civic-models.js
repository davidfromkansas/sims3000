import {projectMiniature as projectCivic,rasterizeMiniature} from './miniature-raster.js?v=architecture-collection-39';
export {projectMiniature as projectCivic} from './miniature-raster.js?v=architecture-collection-39';
