import {projectMiniature as projectCivic,rasterizeMiniature} from './miniature-raster.js?v=available-job-targets-1';
export {projectMiniature as projectCivic} from './miniature-raster.js?v=available-job-targets-1';
