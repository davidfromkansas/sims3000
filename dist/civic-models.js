import {projectMiniature as projectCivic,rasterizeMiniature} from './miniature-raster.js?v=visible-garbage-backlog-1';
export {projectMiniature as projectCivic} from './miniature-raster.js?v=visible-garbage-backlog-1';
