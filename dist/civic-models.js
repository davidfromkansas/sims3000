import {projectMiniature as projectCivic,rasterizeMiniature} from './miniature-raster.js?v=direct-model-paint-2';
export {projectMiniature as projectCivic} from './miniature-raster.js?v=direct-model-paint-2';
