import {projectMiniature as projectCivic,rasterizeMiniature} from './miniature-raster.js?v=architecture-collection-51';
export {projectMiniature as projectCivic} from './miniature-raster.js?v=architecture-collection-51';
