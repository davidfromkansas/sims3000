import {projectMiniature as projectCivic,rasterizeMiniature} from './miniature-raster.js?v=script-clipboard-2';
export {projectMiniature as projectCivic} from './miniature-raster.js?v=script-clipboard-2';
