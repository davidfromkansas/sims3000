import {projectMiniature as projectCivic,rasterizeMiniature} from './miniature-raster.js?v=scenario-dialog-text-1';
export {projectMiniature as projectCivic} from './miniature-raster.js?v=scenario-dialog-text-1';
