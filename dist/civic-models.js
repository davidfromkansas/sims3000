import {projectMiniature as projectCivic,rasterizeMiniature} from './miniature-raster.js?v=architecture-collection-43';
export {projectMiniature as projectCivic} from './miniature-raster.js?v=architecture-collection-43';
