import {projectMiniature as projectCivic,rasterizeMiniature} from './miniature-raster.js?v=architecture-collection-41';
export {projectMiniature as projectCivic} from './miniature-raster.js?v=architecture-collection-41';
