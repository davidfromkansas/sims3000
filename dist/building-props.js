...
import {BUILDING_PROPS,propModelGeometry,shadePropFaces} from './building-prop-models.js?v=architecture-collection-43';
export {BUILDING_PROPS,PROP_CATEGORIES} from './building-prop-models.js?v=architecture-collection-43';
