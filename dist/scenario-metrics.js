import {tileIndex} from './city-grid.js?v=navigation-data-1';
import {STRUCTURE_METRICS} from './scenario-structures.js?v=navigation-data-1';
import {inScenarioArea} from './scenario-area.js?v=navigation-data-1';
import {ORDINANCES} from './ordinances.js?v=navigation-data-1';
import {LANDMARKS,landmarkRoots} from './landmarks.js?v=navigation-data-1';
import {businessRoots} from './business.js?v=navigation-data-1';
