import {MAX_SCENARIO_VARIABLES} from './scenario-variables.js?v=live-scenario-comparisons-2';
import {BUILDING_UTILITY_METRICS} from './scenario-building-utilities.js?v=live-scenario-comparisons-2';
import {NEIGHBOR_METRICS} from './scenario-neighbor-metrics.js?v=live-scenario-comparisons-2';
import {isBuildingLotRoot,buildingLotMembers} from './building-lots.js?v=live-scenario-comparisons-2';
import {averageWaterPollution,averageRoadTraffic,surplusPower,surplusWater} from './city-measures.js?v=live-scenario-comparisons-2';
import {outstandingLoanPayments} from './loan-debt.js?v=live-scenario-comparisons-2';
import {CALENDAR_MONTHS,calendarMonthIndex} from './scenario-calendar.js?v=live-scenario-comparisons-2';
import {tileIndex} from './city-grid.js?v=live-scenario-comparisons-2';
import {STRUCTURE_METRICS} from './scenario-structures.js?v=live-scenario-comparisons-2';
...
import {LANDMARKS,landmarkRoots} from './landmarks.js?v=live-scenario-comparisons-2';
import {businessRoots} from './business.js?v=live-scenario-comparisons-2';
