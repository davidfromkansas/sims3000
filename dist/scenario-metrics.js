...
import {STRUCTURE_METRICS} from './scenario-structures.js?v=variable-maps-1';
import {inScenarioArea} from './scenario-area.js?v=variable-maps-1';
import {ORDINANCES} from './ordinances.js?v=variable-maps-1';
import {LANDMARKS,landmarkRoots} from './landmarks.js?v=variable-maps-1';
import {businessRoots} from './business.js?v=variable-maps-1';
