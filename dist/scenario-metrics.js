...
import {STRUCTURE_METRICS} from './scenario-structures.js?v=large-city-performance-1';
import {inScenarioArea} from './scenario-area.js?v=large-city-performance-1';
import {ORDINANCES} from './ordinances.js?v=large-city-performance-1';
import {LANDMARKS,landmarkRoots} from './landmarks.js?v=large-city-performance-1';
