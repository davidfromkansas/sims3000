import {MAX_SCENARIO_VARIABLES} from './scenario-variables.js?v=scripted-ending-ranks-1';
import {BUILDING_UTILITY_METRICS} from './scenario-building-utilities.js?v=scripted-ending-ranks-1';
import {NEIGHBOR_METRICS} from './scenario-neighbor-metrics.js?v=scripted-ending-ranks-1';
import {isBuildingLotRoot,buildingLotMembers} from './building-lots.js?v=scripted-ending-ranks-1';
import {averageWaterPollution,averageRoadTraffic,surplusPower,surplusWater} from './city-measures.js?v=scripted-ending-ranks-1';
import {outstandingLoanPayments} from './loan-debt.js?v=scripted-ending-ranks-1';
import {CALENDAR_MONTHS,calendarMonthIndex} from './scenario-calendar.js?v=scripted-ending-ranks-1';
import {tileIndex} from './city-grid.js?v=scripted-ending-ranks-1';
import {STRUCTURE_METRICS} from './scenario-structures.js?v=scripted-ending-ranks-1';
...
import {LANDMARKS,landmarkRoots} from './landmarks.js?v=scripted-ending-ranks-1';
import {businessRoots} from './business.js?v=scripted-ending-ranks-1';
