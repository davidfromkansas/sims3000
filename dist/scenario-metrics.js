...
import {STRUCTURE_METRICS} from './scenario-structures.js?v=power-grids-1';
import {inScenarioArea} from './scenario-area.js?v=power-grids-1';
import {ORDINANCES} from './ordinances.js?v=power-grids-1';
import {LANDMARKS,landmarkRoots} from './landmarks.js?v=power-grids-1';
import {businessRoots} from './business.js?v=power-grids-1';
