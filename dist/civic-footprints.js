import {HOSPITAL_BEDS} from './hospital.js?v=fire-coverage-1';
export const SERVICES={police:{size:3,name:'Police station',department:'police',cost:500,upkeep:25,radius:9},fire:{size:3,name:'Fire station',department:'fire',cost:500,upkeep:25,radius:25},hospital:{size:3,name:'Hospital',department:'health',cost:1000,upkeep:40,capacity:HOSPITAL_BEDS},school:{size:3,name:'School',department:'education',cost:500,upkeep:20,capacity:300},jail:{size:3,name:'Jail',department:'police',cost:1500,upkeep:35,capacity:200},college:{size:3,name:'College',department:'education',cost:1000,upkeep:35,capacity:500},library:{size:2,name:'Library',department:'education',cost:500,upkeep:10,capacity:1000},museum:{size:3,name:'Museum',department:'education',cost:1500,upkeep:20,capacity:1500}};
