...
import {PROGRAM_LIMITS} from './scenario-programs.js?v=direct-model-paint-2';
import {startProgramInvocation,advanceProgramInvocation,programInvocationFinished,pendingProgramMessage,programActionSources} from './scenario-program-history.js?v=direct-model-paint-2';
import {activeProgramInvocation} from './scenario-program-invocations.js?v=direct-model-paint-2';
