import {validateAppearance,landscapePalette,landscapeGround} from './city-appearance.js?v=scenario-variable-manager-1';
import {treeCanvas} from './tree-models.js?v=scenario-variable-manager-1';
