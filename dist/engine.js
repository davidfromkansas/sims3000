import {regionalMarketAccess} from './regional-market-access.js?v=expanding-farms-1';
import {freshPetitions,validatePetitions} from './petitions.js?v=expanding-farms-1';
import {validateBuildingDesigns} from './building-designs.js?v=expanding-farms-1';
import {freshDemographics,advanceDemographics,validateDemographics} from './demographics.js?v=expanding-farms-1';
import {powerMonth} from './power-accounting.js?v=expanding-farms-1';
import {initialAgeEducation,advanceEducationCohorts} from './education.js?v=expanding-farms-1';
import {validateBuildingReplacements} from './building-art.js?v=expanding-farms-1';
import {conservationDemand} from './conservation.js?v=expanding-farms-1';
import {LANDMARKS,validateLandmarks} from './landmarks.js?v=expanding-farms-1';
import {maybeUfo} from './ufo.js?v=expanding-farms-1';
import {maybeWhirlpool} from './whirlpool.js?v=expanding-farms-1';
import {maybeToxicCloud} from './toxic-cloud.js?v=expanding-farms-1';
import {maybeSpaceJunk} from './space-junk.js?v=expanding-farms-1';
import {runScenarioEventBatch,scenarioEventPresentation,scenarioEnding} from './scenario-events.js?v=expanding-farms-1';
import {advanceUnrest} from './riots.js?v=expanding-farms-1';
import {maybeLocusts} from './locusts.js?v=expanding-farms-1';
import {wasteState,wasteMonth} from './waste-accounting.js?v=expanding-farms-1';
import {BUSINESSES,freshBusiness,advanceBusiness,businessStats,validateBusiness,businessRoots,businessOffer} from './business.js?v=expanding-farms-1';
import {TECHNOLOGY,available} from './technology.js?v=expanding-farms-1';
import {proposeTunnel,installTunnel,removeTunnels,tunnelStats,validateTunnels,tunnelAt} from './tunnels.js?v=expanding-farms-1';
import {REWARDS,freshRewards,advanceRewards,rewardStats,validateRewards} from './rewards.js?v=expanding-farms-1';
import {normalizeIndustry,advanceIndustry,industryStats,industrialJobs} from './industry.js?v=expanding-farms-1';
import {STRUCTURES} from './structures.js?v=expanding-farms-1';
import {RECREATION,recreationStats} from './recreation.js?v=expanding-farms-1';
import {reportSnapshot,HISTORY_LIMIT,cleanHistory} from './reports.js?v=expanding-farms-1';
import {LANDSCAPE,planLandscape} from './landscape.js?v=expanding-farms-1';
import {POWER_PLANTS,plantCapacity,advancePower,powerStats} from './power.js?v=expanding-farms-1';
import {advanceScenario,validateScenario} from './scenarios.js?v=expanding-farms-1';
import {explodePlant,ignite,freshEmergency,emergencyStats,maybeIgnite,maybeEarthquake,maybeTornado,validateEmergency} from './emergency.js?v=expanding-farms-1';
import {freshRegion,resetTrades,tradeCapacity,importGarbage,exportGarbage,regionBudget,settleRegion,validateRegion} from './region.js?v=expanding-farms-1';
import {FACILITIES,recomputeFacilities,advanceFacilities} from './facilities.js?v=expanding-farms-1';
import {streetGraph,rampCrossings} from './highway.js?v=expanding-farms-1';
import {STATIONS} from './rail.js?v=expanding-farms-1';
import {freshTransport,recomputeTransport,advanceTransit,validateTransport,roadNeighbors,bridgePlan} from './transport.js?v=expanding-farms-1';
import {SERVICES,freshCivic,recomputeCivic,advanceCivic,validateCivic} from './civic.js?v=expanding-farms-1';
import {queueBudgetReview,freshFinance,changeBudget,takeLoan,settleLoans,advanceRoads,recomputeEnvironment,landDensityLimit,budgetForecast,validateFinance} from './economy.js?v=expanding-farms-1';
import {WASTE_STRUCTURES,wastePower,advanceWaste,WATER_STRUCTURES,advanceWater,recomputeWater,garbageStats,processGarbage,occupancy,LANDFILL_CAPACITY} from './utilities.js?v=expanding-farms-1';
// SIMS3000 milestone 3. Gameplay constants are explicit approximations; see docs/manual-fidelity.md.
export const SIZE=48, VERSION=90;
