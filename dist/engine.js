import {cityGrid,MAP_SIZES} from './city-grid.js?v=authored-goals-1';
import {regionalMarketAccess} from './regional-market-access.js?v=authored-goals-1';
import {freshPetitions,validatePetitions} from './petitions.js?v=authored-goals-1';
import {validateBuildingDesigns} from './building-designs.js?v=authored-goals-1';
import {freshDemographics,advanceDemographics,validateDemographics} from './demographics.js?v=authored-goals-1';
import {powerMonth} from './power-accounting.js?v=authored-goals-1';
import {initialAgeEducation,advanceEducationCohorts} from './education.js?v=authored-goals-1';
import {validateBuildingReplacements} from './building-art.js?v=authored-goals-1';
import {conservationDemand} from './conservation.js?v=authored-goals-1';
import {LANDMARKS,validateLandmarks} from './landmarks.js?v=authored-goals-1';
import {maybeUfo} from './ufo.js?v=authored-goals-1';
import {maybeWhirlpool} from './whirlpool.js?v=authored-goals-1';
import {maybeToxicCloud} from './toxic-cloud.js?v=authored-goals-1';
import {maybeSpaceJunk} from './space-junk.js?v=authored-goals-1';
import {runScenarioEventBatch,scenarioEventPresentation,scenarioEnding} from './scenario-events.js?v=authored-goals-1';
import {advanceUnrest} from './riots.js?v=authored-goals-1';
import {maybeLocusts} from './locusts.js?v=authored-goals-1';
import {wasteState,wasteMonth} from './waste-accounting.js?v=authored-goals-1';
import {BUSINESSES,freshBusiness,advanceBusiness,businessStats,validateBusiness,businessRoots,businessOffer} from './business.js?v=authored-goals-1';
import {TECHNOLOGY,available} from './technology.js?v=authored-goals-1';
import {proposeTunnel,installTunnel,removeTunnels,tunnelStats,validateTunnels,tunnelAt} from './tunnels.js?v=authored-goals-1';
import {REWARDS,freshRewards,advanceRewards,rewardStats,validateRewards} from './rewards.js?v=authored-goals-1';
import {normalizeIndustry,advanceIndustry,industryStats,industrialJobs} from './industry.js?v=authored-goals-1';
import {STRUCTURES} from './structures.js?v=authored-goals-1';
import {RECREATION,recreationStats} from './recreation.js?v=authored-goals-1';
import {reportSnapshot,HISTORY_LIMIT,cleanHistory} from './reports.js?v=authored-goals-1';
import {LANDSCAPE,planLandscape} from './landscape.js?v=authored-goals-1';
import {POWER_PLANTS,plantCapacity,advancePower,powerStats} from './power.js?v=authored-goals-1';
import {advanceScenario,validateScenario} from './scenarios.js?v=authored-goals-1';
import {explodePlant,ignite,freshEmergency,emergencyStats,maybeIgnite,maybeEarthquake,maybeTornado,validateEmergency} from './emergency.js?v=authored-goals-1';
import {freshRegion,resetTrades,tradeCapacity,importGarbage,exportGarbage,regionBudget,settleRegion,validateRegion} from './region.js?v=authored-goals-1';
import {FACILITIES,recomputeFacilities,advanceFacilities} from './facilities.js?v=authored-goals-1';
import {streetGraph,rampCrossings} from './highway.js?v=authored-goals-1';
import {STATIONS} from './rail.js?v=authored-goals-1';
import {freshTransport,recomputeTransport,advanceTransit,validateTransport,roadNeighbors,bridgePlan} from './transport.js?v=authored-goals-1';
import {SERVICES,freshCivic,recomputeCivic,advanceCivic,validateCivic} from './civic.js?v=authored-goals-1';
import {queueBudgetReview,freshFinance,changeBudget,takeLoan,settleLoans,advanceRoads,recomputeEnvironment,landDensityLimit,budgetForecast,validateFinance} from './economy.js?v=authored-goals-1';
import {WASTE_STRUCTURES,wastePower,advanceWaste,WATER_STRUCTURES,advanceWater,recomputeWater,garbageStats,processGarbage,occupancy,LANDFILL_CAPACITY} from './utilities.js?v=authored-goals-1';
// SIMS3000 milestone 3. Gameplay constants are explicit approximations; see docs/manual-fidelity.md.
export const SIZE=48, VERSION=94;
