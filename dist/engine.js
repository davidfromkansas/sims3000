import {cityGrid,MAP_SIZES} from './city-grid.js?v=background-months-1';
import {regionalMarketAccess} from './regional-market-access.js?v=background-months-1';
import {freshPetitions,validatePetitions} from './petitions.js?v=background-months-1';
import {validateBuildingDesigns} from './building-designs.js?v=background-months-1';
import {freshDemographics,advanceDemographics,validateDemographics} from './demographics.js?v=background-months-1';
import {powerMonth} from './power-accounting.js?v=background-months-1';
import {initialAgeEducation,advanceEducationCohorts} from './education.js?v=background-months-1';
import {validateBuildingReplacements} from './building-art.js?v=background-months-1';
import {conservationDemand} from './conservation.js?v=background-months-1';
import {LANDMARKS,validateLandmarks} from './landmarks.js?v=background-months-1';
import {maybeUfo} from './ufo.js?v=background-months-1';
import {maybeWhirlpool} from './whirlpool.js?v=background-months-1';
import {maybeToxicCloud} from './toxic-cloud.js?v=background-months-1';
import {maybeSpaceJunk} from './space-junk.js?v=background-months-1';
import {runScenarioEventBatch,scenarioEventPresentation,scenarioEnding} from './scenario-events.js?v=background-months-1';
import {advanceUnrest} from './riots.js?v=background-months-1';
import {maybeLocusts} from './locusts.js?v=background-months-1';
import {wasteState,wasteMonth} from './waste-accounting.js?v=background-months-1';
import {BUSINESSES,freshBusiness,advanceBusiness,businessStats,validateBusiness,businessRoots,businessOffer} from './business.js?v=background-months-1';
import {TECHNOLOGY,available} from './technology.js?v=background-months-1';
import {proposeTunnel,installTunnel,removeTunnels,tunnelStats,validateTunnels,tunnelAt} from './tunnels.js?v=background-months-1';
import {REWARDS,freshRewards,advanceRewards,rewardStats,validateRewards} from './rewards.js?v=background-months-1';
import {normalizeIndustry,advanceIndustry,industryStats,industrialJobs} from './industry.js?v=background-months-1';
import {STRUCTURES} from './structures.js?v=background-months-1';
import {RECREATION,recreationStats} from './recreation.js?v=background-months-1';
import {reportSnapshot,HISTORY_LIMIT,cleanHistory} from './reports.js?v=background-months-1';
import {LANDSCAPE,planLandscape} from './landscape.js?v=background-months-1';
import {POWER_PLANTS,plantCapacity,advancePower,powerStats} from './power.js?v=background-months-1';
import {advanceScenario,validateScenario} from './scenarios.js?v=background-months-1';
import {explodePlant,ignite,freshEmergency,emergencyStats,maybeIgnite,maybeEarthquake,maybeTornado,validateEmergency} from './emergency.js?v=background-months-1';
import {freshRegion,resetTrades,tradeCapacity,importGarbage,exportGarbage,regionBudget,settleRegion,validateRegion} from './region.js?v=background-months-1';
import {FACILITIES,recomputeFacilities,advanceFacilities} from './facilities.js?v=background-months-1';
import {streetGraph,rampCrossings} from './highway.js?v=background-months-1';
import {STATIONS} from './rail.js?v=background-months-1';
import {freshTransport,recomputeTransport,advanceTransit,validateTransport,roadNeighbors,bridgePlan} from './transport.js?v=background-months-1';
import {SERVICES,freshCivic,recomputeCivic,advanceCivic,validateCivic} from './civic.js?v=background-months-1';
import {queueBudgetReview,freshFinance,changeBudget,takeLoan,settleLoans,advanceRoads,recomputeEnvironment,landDensityLimit,budgetForecast,validateFinance} from './economy.js?v=background-months-1';
import {WASTE_STRUCTURES,wastePower,advanceWaste,WATER_STRUCTURES,advanceWater,recomputeWater,garbageStats,processGarbage,occupancy,LANDFILL_CAPACITY} from './utilities.js?v=background-months-1';
