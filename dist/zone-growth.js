import {economicGrowthFits} from './economic-cap.js?v=architecture-collection-55';
import {residentialGrowthFits} from './residential-cap.js?v=architecture-collection-55';
import {abandonmentExplanation} from './abandonment-history.js?v=architecture-collection-55';
import {landDensityLimit} from './economy.js?v=architecture-collection-55';
import {needsEstablishedWater} from './water-service.js?v=architecture-collection-55';
import {buildingLotMembers,isBuildingLotRoot} from './building-lots.js?v=architecture-collection-55';
