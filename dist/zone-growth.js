import {economicGrowthFits} from './economic-cap.js?v=stadium-match-day-1';
import {residentialGrowthFits} from './residential-cap.js?v=stadium-match-day-1';
import {abandonmentExplanation} from './abandonment-history.js?v=stadium-match-day-1';
import {landDensityLimit} from './economy.js?v=stadium-match-day-1';
import {needsEstablishedWater} from './water-service.js?v=stadium-match-day-1';
import {buildingLotMembers,isBuildingLotRoot} from './building-lots.js?v=stadium-match-day-1';
