import {economicGrowthFits} from './economic-cap.js?v=architecture-collection-43';
import {residentialGrowthFits} from './residential-cap.js?v=architecture-collection-43';
import {abandonmentExplanation} from './abandonment-history.js?v=architecture-collection-43';
import {landDensityLimit} from './economy.js?v=architecture-collection-43';
import {needsEstablishedWater} from './water-service.js?v=architecture-collection-43';
import {buildingLotMembers,isBuildingLotRoot} from './building-lots.js?v=architecture-collection-43';
