import {economicGrowthFits} from './economic-cap.js?v=live-scenario-comparisons-2';
import {residentialGrowthFits} from './residential-cap.js?v=live-scenario-comparisons-2';
import {abandonmentExplanation} from './abandonment-history.js?v=live-scenario-comparisons-2';
import {landDensityLimit} from './economy.js?v=live-scenario-comparisons-2';
import {needsEstablishedWater} from './water-service.js?v=live-scenario-comparisons-2';
import {buildingLotMembers,isBuildingLotRoot} from './building-lots.js?v=live-scenario-comparisons-2';
