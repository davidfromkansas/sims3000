import {economicGrowthFits} from './economic-cap.js?v=economic-cap-1';
import {residentialGrowthFits} from './residential-cap.js?v=economic-cap-1';
import {abandonmentExplanation} from './abandonment-history.js?v=economic-cap-1';
import {landDensityLimit} from './economy.js?v=economic-cap-1';
import {needsEstablishedWater} from './water-service.js?v=economic-cap-1';
import {buildingLotMembers,isBuildingLotRoot} from './building-lots.js?v=economic-cap-1';
