import {economicGrowthFits} from './economic-cap.js?v=stock-exchange-1';
import {residentialGrowthFits} from './residential-cap.js?v=stock-exchange-1';
import {abandonmentExplanation} from './abandonment-history.js?v=stock-exchange-1';
import {landDensityLimit} from './economy.js?v=stock-exchange-1';
import {needsEstablishedWater} from './water-service.js?v=stock-exchange-1';
import {buildingLotMembers,isBuildingLotRoot} from './building-lots.js?v=stock-exchange-1';
