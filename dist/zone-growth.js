import {economicGrowthFits} from './economic-cap.js?v=civic-reward-fidelity-1';
import {residentialGrowthFits} from './residential-cap.js?v=civic-reward-fidelity-1';
import {abandonmentExplanation} from './abandonment-history.js?v=civic-reward-fidelity-1';
import {landDensityLimit} from './economy.js?v=civic-reward-fidelity-1';
import {needsEstablishedWater} from './water-service.js?v=civic-reward-fidelity-1';
import {buildingLotMembers,isBuildingLotRoot} from './building-lots.js?v=civic-reward-fidelity-1';
