import {economicGrowthFits} from './economic-cap.js?v=responsive-metropolis-3';
import {residentialGrowthFits} from './residential-cap.js?v=responsive-metropolis-3';
import {abandonmentExplanation} from './abandonment-history.js?v=responsive-metropolis-3';
import {landDensityLimit} from './economy.js?v=responsive-metropolis-3';
import {needsEstablishedWater} from './water-service.js?v=responsive-metropolis-3';
import {buildingLotMembers,isBuildingLotRoot} from './building-lots.js?v=responsive-metropolis-3';
