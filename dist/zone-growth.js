import {economicGrowthFits} from './economic-cap.js?v=architecture-collection-41';
import {residentialGrowthFits} from './residential-cap.js?v=architecture-collection-41';
import {abandonmentExplanation} from './abandonment-history.js?v=architecture-collection-41';
import {landDensityLimit} from './economy.js?v=architecture-collection-41';
import {needsEstablishedWater} from './water-service.js?v=architecture-collection-41';
import {buildingLotMembers,isBuildingLotRoot} from './building-lots.js?v=architecture-collection-41';
