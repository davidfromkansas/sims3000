import {residentialGrowthFits} from './residential-cap.js?v=residential-cap-1';
import {abandonmentExplanation} from './abandonment-history.js?v=residential-cap-1';
import {landDensityLimit} from './economy.js?v=residential-cap-1';
import {needsEstablishedWater} from './water-service.js?v=residential-cap-1';
import {buildingLotMembers,isBuildingLotRoot} from './building-lots.js?v=residential-cap-1';
...
export function abandonedRecovery(c,t){
 ...
 if(conditions.demand<=0)reasons.push('demand');if(!residentialGrowthFits(c,t,members))reasons.push('residentialCap');
