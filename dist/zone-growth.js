import {economicGrowthFits} from './economic-cap.js?v=architecture-collection-36';
import {residentialGrowthFits} from './residential-cap.js?v=architecture-collection-36';
import {abandonmentExplanation} from './abandonment-history.js?v=architecture-collection-36';
import {landDensityLimit} from './economy.js?v=architecture-collection-36';
import {needsEstablishedWater} from './water-service.js?v=architecture-collection-36';
import {buildingLotMembers,isBuildingLotRoot} from './building-lots.js?v=architecture-collection-36';
