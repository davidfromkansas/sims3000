import {abandonmentExplanation} from './abandonment-history.js?v=first-repayment-1';
import {landDensityLimit} from './economy.js?v=first-repayment-1';
import {needsEstablishedWater} from './water-service.js?v=first-repayment-1';
import {buildingLotMembers,isBuildingLotRoot} from './building-lots.js?v=first-repayment-1';
