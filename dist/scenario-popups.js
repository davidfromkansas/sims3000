import {presenterMarkup} from './scenario-presenters.js?v=local-city-ambience-1';
import {escapeAnnouncement} from './scenario-announcements.js?v=local-city-ambience-1';
