import {pendingProgramPopup} from './scenario-program-invocations.js?v=scenario-result-1';
import {presenterMarkup} from './scenario-presenters.js?v=scenario-result-1';
