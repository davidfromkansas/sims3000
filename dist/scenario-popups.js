import {pendingProgramPopup} from './scenario-program-invocations.js?v=architecture-collection-48';
import {presenterMarkup} from './scenario-presenters.js?v=architecture-collection-48';
