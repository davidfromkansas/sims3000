import {pendingProgramPopup} from './scenario-program-invocations.js?v=scenario-variable-manager-1';
import {presenterMarkup} from './scenario-presenters.js?v=scenario-variable-manager-1';
