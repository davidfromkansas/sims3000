import {pendingProgramPopup} from './scenario-program-invocations.js?v=architecture-workspace-1';
import {presenterMarkup} from './scenario-presenters.js?v=architecture-workspace-1';
