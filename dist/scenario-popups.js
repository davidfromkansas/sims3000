import {pendingProgramPopup} from './scenario-program-invocations.js?v=available-job-targets-1';
import {presenterMarkup} from './scenario-presenters.js?v=available-job-targets-1';
