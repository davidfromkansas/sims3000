import {validateBuildingReplacements,canReplaceBuilding,buildingStyleKey,REPLACEABLE_STYLES} from './building-art.js?v=first-repayment-1';
import {validateBuildingDesigns} from './building-designs.js?v=first-repayment-1';
import {parseBuildingSlot} from './building-footprints.js?v=first-repayment-1';
import {isBuildingLotRoot} from './building-lots.js?v=first-repayment-1';
