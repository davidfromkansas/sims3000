import {validateBuildingReplacements,canReplaceBuilding,buildingStyleKey,REPLACEABLE_STYLES} from './building-art.js?v=utility-usage-trends-1';
import {validateBuildingDesigns} from './building-designs.js?v=utility-usage-trends-1';
import {parseBuildingSlot} from './building-footprints.js?v=utility-usage-trends-1';
import {isBuildingLotRoot} from './building-lots.js?v=utility-usage-trends-1';
