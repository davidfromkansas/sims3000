import {validateBuildingReplacements,canReplaceBuilding,buildingStyleKey,REPLACEABLE_STYLES} from './building-art.js?v=architecture-workspace-1';
import {validateBuildingDesigns} from './building-designs.js?v=architecture-workspace-1';
import {buildingSlot,parseBuildingSlot} from './building-footprints.js?v=architecture-workspace-1';
import {isBuildingLotRoot} from './building-lots.js?v=architecture-workspace-1';
