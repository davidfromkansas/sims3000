import {validateBuildingReplacements,canReplaceBuilding,buildingStyleKey,REPLACEABLE_STYLES} from './building-art.js?v=large-city-routing-1';
import {validateBuildingDesigns} from './building-designs.js?v=large-city-routing-1';
import {parseBuildingSlot} from './building-footprints.js?v=large-city-routing-1';
import {isBuildingLotRoot} from './building-lots.js?v=large-city-routing-1';
