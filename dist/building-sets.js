import {validateBuildingReplacements,canReplaceBuilding,buildingStyleKey,REPLACEABLE_STYLES} from './building-art.js?v=automatic-police-response-1';
import {validateBuildingDesigns} from './building-designs.js?v=automatic-police-response-1';
import {parseBuildingSlot} from './building-footprints.js?v=automatic-police-response-1';
import {isBuildingLotRoot} from './building-lots.js?v=automatic-police-response-1';
