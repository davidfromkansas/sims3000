import {validateBuildingReplacements,canReplaceBuilding,buildingStyleKey,REPLACEABLE_STYLES} from './building-art.js?v=script-clipboard-2';
import {validateBuildingDesigns} from './building-designs.js?v=script-clipboard-2';
import {parseBuildingSlot} from './building-footprints.js?v=script-clipboard-2';
import {isBuildingLotRoot} from './building-lots.js?v=script-clipboard-2';
