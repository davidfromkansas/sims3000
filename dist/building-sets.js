import {validateBuildingReplacements,canReplaceBuilding,buildingStyleKey,REPLACEABLE_STYLES} from './building-art.js?v=architecture-collection-43';
import {validateBuildingDesigns} from './building-designs.js?v=architecture-collection-43';
import {buildingSlot,parseBuildingSlot} from './building-footprints.js?v=architecture-collection-43';
import {isBuildingLotRoot} from './building-lots.js?v=architecture-collection-43';
