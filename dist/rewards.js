...
export function rewardRequirements(c,k){
 ...
 return k==='cityHall'?[population(20000),approval(50)]:k==='mayorHouse'?[population(5000),approval(50)]:k==='stadium'?[population(150000),approval(STADIUM_APPROVAL)]:k==='university'?[{label:'Education quotient',current:s.education,target:70,met:s.education>=70}]:[];
}
