import {LANDMARKS} from './landmarks.js?v=civic-models-1';
import {BUSINESSES} from './business.js?v=civic-models-1';
import {REWARDS} from './rewards.js?v=civic-models-1';
import {POWER_PLANTS} from './power.js?v=civic-models-1';
import {RECREATION} from './recreation.js?v=civic-models-1';
